...
::_M_erase(_Rb_tree<std::string,std::pair<std::string_const,std::string>,std::_Select1st<std::pair<std::string_const,std::string>>,std::less<std::string>,pool_allocator<std::pair<std::string_const,std::string>>>
...
int TIntermBinary__setLeft(this, param_1)
  ...
  unsigned char *param_1;
{
  *(TIntermTyped **)(this + 0x34) = param_1;
  return;
}
...
int TIntermBinary__setRight(this, param_1)
  ...
  unsigned char *param_1;
{
  *(TIntermTyped **)(this + 0x38) = param_1;
  return;
}
...
std::
_Rb_tree<std::string,std::pair<std::string_const,std::string>,std::_Select1st<std::pair<std::string_const,std::string>>,std::less<std::string>,pool_allocator<std::pair<std::string_const,std::string>>>
::clear(_Rb_tree<std::string,std::pair<std::string_const,std::string>,std::_Select1st<std::pair<std::string_const,std::string>>,std::less<std::string>,pool_allocator<std::pair<std::string_const,std::string>>>
        *this)
