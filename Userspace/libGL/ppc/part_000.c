...
undefined8 _CGLSetCurrentContext(param_1)
  void *param_1;
{
  ...
  *(undefined1 ***)((int)param_1 + 0xab0) = local_50;
...
int _CGLGetCurrentContext()
{
  ...
  if (_gll_cc != (void *)0x0) {
    pvVar1 = _gll_cc;
    if (*(undefined1 ***)((int)_gll_cc + 0xab0) != local_60) {
      ...
      _gll_cc = pvVar1;
      *(undefined1 ***)((int)pvVar1 + 0xab0) = local_60;
    }
    pvVar2 = (void *)0x0;
    if (pvVar1 != _gll_noop) {
      pvVar2 = pvVar1;
