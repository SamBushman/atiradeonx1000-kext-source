...
int FUN_001281b0(param_1, param_2, param_3, param_4, param_5, param_6, param_7)
  undefined4 param_1;
  undefined4 param_2;
  undefined4 param_3;
  undefined4 param_4;
  ...
  undefined4 param_4;
{
  ...
  *param_3 = 0xffffffff;
  ...
  (*(char *)((unsigned char *)ghidra_home + 12)) = (char)((uint)param_4 >> 0x18);
  (*(char *)((unsigned char *)ghidra_home + 13)) = (char)((uint)param_4 >> 0x10);
  (*(char *)((unsigned char *)ghidra_home + 14)) = (char)((uint)param_4 >> 8);
  (*(char *)((unsigned char *)ghidra_home + 15)) = (char)param_4;
  puVar5 = &DAT_001aff0c;
  while( true ) {
    uVar7 = *puVar5;
    if ((((GH_U2F((unsigned int)(puVar5[1])) == fVar2) &&
         (((*(char *)((unsigned char *)ghidra_home + 12)) == '\x04' || (fVar1 == GH_U2F((unsigned int)(puVar5[-4])))))) &&
        (((*(char *)((unsigned char *)ghidra_home + 13)) == '\x04' || (fVar1 == GH_U2F((unsigned int)(puVar5[-3])))))) &&
       ((((*(char *)((unsigned char *)ghidra_home + 14)) == '\x04' || (fVar1 == GH_U2F((unsigned int)(puVar5[-2])))) &&
        (((*(char *)((unsigned char *)ghidra_home + 15)) == '\x04' || (GH_U2F((unsigned int)(puVar5[-1])) == fVar1)))))) break;
    puVar5 = puVar5 + 6;
  ...
  int *param_4;
{
  ...
  if (*param_4 != 0x4040404) {
    ...
    iVar6 = FUN_000f5f94(uVar8,param_3,param_4,piVar3,pcVar5,iVar6,pdVar7);
    if (iVar6 != 0) {
      return iVar6;
    }
    ...
    if ((iVar6 != 0) && (iVar9 = (**(code **)(*param_1 + 0x100))(param_1,param_4), iVar9 != 0)) {
      return iVar6;
    }
  }
  return 0;
...
int FUN_00128930(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10)
  undefined4 param_1;
  int param_2;
  int param_3;
  int param_4;
      ...
      *(int *)(param_3 + 0x3ac) = iVar5;
      ...
      if (iVar5 == 0) {
        ...
        *(undefined4 *)(iVar5 + 0x10) = uVar1;
        ((void (*)())FUN_000f79c4)(piVar4,*(undefined4 *)(param_3 + 0x6c4),2,dVar10,dVar10,dVar10,dVar10);
        FUN_00103d50(piVar4 + 0x2f,1,1);
        dVar10 = (double)FLOAT_001aa0e8;
        ((void (*)())FUN_000f79c4)(piVar4,*(undefined4 *)(param_3 + 0x6c4),3,dVar10,dVar10,dVar10,dVar10);
...
int FUN_00128d7c(param_1, param_2, param_3, param_4, param_5, param_6, param_7)
  undefined4 param_1;
  float *param_2;
  undefined4 param_3;
  undefined4 param_4;
...
/* FUN_00128fd0 @ 0x128fd0 (312 bytes) */
...
/* FUN_00129130 @ 0x129130 (312 bytes) */
...
int FUN_00129694(param_1, param_2, param_3, param_4, param_5, param_6, param_7)
  undefined4 param_1;
  undefined4 param_2;
  undefined4 param_3;
  undefined4 param_4;
  ...
  uint param_6;
{
  ...
  iVar2 = *(int *)(((unsigned char *)0x00001728) + param_1);
  *(int *)(((unsigned char *)0x00001728) + param_1) = iVar2 + 1;
  uVar3 = 0;
  iVar2 = param_1 + iVar2 * 0x34 + 0xd60;
  iVar1 = iVar2 + 8;
...
int FUN_00129748(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10)
  int param_1;
  undefined4 param_2;
  int param_3;
  undefined4 param_4;
  ...
  undefined4 param_10;
{
  ...
  *(int *)(((unsigned char *)0x00001728) + param_1) = iVar1 + 1;
  iVar1 = param_1 + iVar1 * 0x34 + 0xd60;
  *(int *)(iVar1 + 8) = param_3;
  ...
  undefined4 param_3;
{
  ...
  *(undefined1 *)(iVar1 + 0x37) = (undefined1)param_3;
  *(undefined1 *)(iVar1 + 0x39) = 1;
  *(undefined1 *)(iVar1 + 0x3b) = 3;
  *(undefined4 *)(iVar1 + 0x18) = 0xf;
  *(undefined4 *)(iVar1 + 0x1c) = 1;
  *(undefined4 *)(iVar1 + 0xc) = param_2;
  *(undefined1 *)(iVar1 + 0x34) = (undefined1)param_3;
  *(undefined1 *)(iVar1 + 0x35) = (undefined1)param_3;
  *(undefined1 *)(iVar1 + 0x36) = (undefined1)param_3;
  return;
}
...
/* FUN_0012a00c @ 0x12a00c (480 bytes) */
int FUN_0012a00c(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10)
  undefined4 param_1;
  undefined4 param_2;
  undefined4 param_3;
  undefined4 param_4;
  ...
  int param_10;
{
  ...
  iVar7 = param_10;
  uVar8 = *(undefined4 *)(param_10 + 0x6c4);
  switch(param_2) {
  case 0:
    uVar2 = 0x27;
    bVar1 = false;
  ...
  bVar1 = !bVar1;
  (*(unsigned int *)((unsigned char *)ghidra_home + 24)) = param_7;
  uVar2 = FUN_001043f0(uVar2,param_10);
  ...
  *(int *)(iVar4 + 8) = iVar10;
  FUN_000f92fc(uVar8,uVar2,param_9);
...
int FUN_0012a3c0(param_1, param_2, param_3, param_4, param_5, param_6, param_7)
  undefined4 param_1;
  int param_2;
  undefined4 param_3;
  undefined4 param_4;
...
/* FUN_0012a578 @ 0x12a578 (288 bytes) */
...
/* FUN_0012a6c0 @ 0x12a6c0 (288 bytes) */
...
/* FUN_0012a808 @ 0x12a808 (124 bytes) */
...
/* FUN_0012a8bc @ 0x12a8bc (124 bytes) */
  ...
  int param_2;
{
  ...
  *(undefined4 *)(param_2 + 0x138) = uVar2;
  ...
  uVar2 = FUN_000e7804(param_2,extraout_r4,in_r5,in_r6,in_r7,in_r8,in_r9);
  iVar1 = FUN_0010b5f8(uVar2);
  ...
  int *param_2;
{
  ...
  piVar2 = (int *)param_2[0x4b];
  while( true ) {
    while( true ) {
      while( true ) {
        a0 = (int *)FUN_000e920c(param_2,0);
        iVar1 = (**(code **)(*a0 + 0x10))(a0);
        if ((iVar1 != 0) && (*(int *)(iVar1 + 300) == param_1)) {
          iVar1 = (**(code **)(*piVar2 + 0x2c))(piVar2);
          piVar2 = (int *)FUN_000e9184(piVar2,(uint)(iVar1 != 0));
          return piVar2;
        }
        iVar1 = (**(code **)(*a0 + 0x24))(a0);
        if (iVar1 == 0) break;
        param_2 = (int *)a0[0x4f];
      }
      iVar1 = (**(code **)(*a0 + 0x2c))(a0);
      if (iVar1 == 0) break;
      param_2 = (int *)a0[0x55];
    }
    iVar1 = (**(code **)(*param_2 + 0x38))(param_2);
    if ((iVar1 != 0) || (iVar1 = (**(code **)(*param_2 + 0x3c))(param_2), iVar1 != 0)) break;
    iVar1 = (**(code **)(*a0 + 0x28))(a0);
    if ((iVar1 == 0) && (iVar1 = (**(code **)(*a0 + 0x30))(a0), iVar1 == 0)) {
...
int FUN_0012ae6c(param_1, param_2, param_3, param_4, param_5, param_6, param_7)
  int param_1;
  undefined4 param_2;
  undefined4 param_3;
  undefined4 param_4;
