  ...
  do {
    ...
    if (iVar14 - 0x12U < 3) {
      ...
      if (iVar14 == 0x13) {
        ...
        if (iVar13 != 0) {
          iVar14 = FUN_0015800c(iVar16,piVar4,iVar13,uVar12,uVar1,param_2);
          if (iVar14 == 0) {
            iVar14 = FUN_0015800c(iVar16,piVar6,iVar13,uVar12,uVar2,param_2);
            if (iVar14 != 0) {
...
LAB_001593b8:
        if (iVar13 != 0) {
          ...
          uVar8 = local_50[0];
          iVar14 = FUN_0015800c(iVar16,uVar9,iVar13,uVar12,local_50[0],param_2);
          if (iVar14 != 0) {
            iVar14 = FUN_0015800c(iVar16,piVar4,iVar13,uVar12,uVar1,param_2);
            if (iVar14 == 0) {
              iVar14 = FUN_0015800c(iVar16,piVar6,iVar13,uVar12,uVar2,param_2);
            ...
            *puVar7 = uVar9;
              ...
              ((iVar14 = FUN_0015800c(iVar16,piVar4,iVar13,uVar12,uVar1,param_2), iVar14 != 0 &&
               (iVar14 = FUN_0015800c(iVar16,piVar6,iVar13,uVar12,uVar2,param_2), iVar14 != 0)))) {
        *(undefined4 *)(iVar16 + 0x124) = 0;
        if (param_1 == iVar16) {
          uVar11 = 1;
        }
