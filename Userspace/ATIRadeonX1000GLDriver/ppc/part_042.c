  ...
  int param_3;
{
  ...
  iVar10 = param_3;
  uVar12 = (**(code **)(*param_1 + 0x40))();
  if ((int)((ulonglong)uVar12 >> 0x20) != 0) {
    return;
  }
  uVar5 = FUN_000e7804(param_1,(int)uVar12,iVar10,in_r6,in_r7,in_r8,in_r9);
  uVar11 = param_2[1];
  if (uVar11 < *param_2) {
    _memset(uVar11 * 4 + param_2[2],0,4);
    puVar6 = (undefined4 *)(uVar11 * 4 + param_2[2]);
    param_2[1] = uVar11 + 1;
  }
  else {
    puVar6 = (undefined4 *)FUN_0019423c(param_2,uVar11);
  }
  *puVar6 = uVar5;
  bVar1 = 0;
  uVar11 = param_2[1];
  ...
  do {
    ...
    if (uVar11 - 1 < param_2[1]) {
      piVar7 = (int *)((uVar11 - 1) * 4 + param_2[2]);
    }
    iVar10 = *piVar7;
    ...
    if (0 < *(int *)(iVar10 + 0x84)) {
      iVar9 = 1;
      do {
        piVar7 = (int *)FUN_00105594(iVar10,iVar9);
        if (piVar7 != (int *)0x0) {
          iVar8 = (**(code **)(*piVar7 + 0x28))();
          if (iVar8 == 0) {
            iVar8 = (**(code **)(*piVar7 + 0x4c))(piVar7);
            if (iVar8 != 0) {
              bVar1 = 1;
            }
          }
          ...
          if ((bool)(bVar2 & bVar1)) {
            ...
            piVar3 = (int *)(*(int **)(iVar8 + 0x98))[2];
            goto joined_r0x0013a104;
          }
          if (param_3 != piVar7[0x54]) {
            piVar7[0x54] = param_3;
            uVar11 = param_2[1];
            if (uVar11 < *param_2) {
              _memset(uVar11 * 4 + param_2[2],0,4);
...
joined_r0x0013a104:
  ...
  if ((piVar7[5] & 1U) != 0) {
    iVar10 = (**(code **)(*piVar7 + 0x28))(piVar7);
  ...
  int param_3;
{
  ...
  if (iVar3 != 0) {
    ...
    if ((int)((ulonglong)uVar18 >> 0x20) == 0) {
      uVar18 = FUN_000e7804(param_1,(int)uVar18,iVar7,in_r6,in_r7,in_r8,in_r9);
      if ((*(int *)(*(int *)((int)((ulonglong)uVar18 >> 0x20) + 0x88) + 8) == 0x8b) ||
         (iVar3 = FUN_000e7804(param_1,(int)uVar18,iVar7,in_r6,in_r7,in_r8,in_r9),
          ...
          do {
            ...
            if (in_r9 != (int *)0x0) {
              ...
              if (((iVar5 == 0) && (iVar5 = (**(code **)(*piVar15 + 0x38))(piVar15), iVar5 == 0)) &&
                ...
                iVar11 = iVar11 + 1;
                if ((iVar14 == piVar1[0x56]) && (iVar5 = (**(code **)(*piVar1 + 100))(), iVar5 != 0)
                   ) {
...
LAB_0013cd68:
                  iVar7 = iVar14;
                  in_r6 = iVar13;
                  iVar5 = FUN_00139034(piVar1,param_1,iVar14,iVar13);
                  bVar17 = iVar5 != 0;
                }
...
LAB_0013cee8:
        ...
        iVar5 = FUN_00194034(iVar14 + 0x90);
        if (((iVar16 == iVar5) && (iVar16 = FUN_00194034(iVar13 + 0x90), iVar16 == iVar12 + 2)) &&
          ...
          iVar7 = FUN_000e7804(param_1,(int)uVar18,iVar7,in_r6,in_r7,in_r8,in_r9);
          uVar10 = DAT_001b001c;
          if (*(int *)(*(int *)(iVar7 + 0x88) + 8) == 0x8c) {
            iVar11 = FUN_001054ec(iVar7,1);
            uVar10 = *(undefined4 *)(iVar11 + 0x10);
            FUN_000ef970(param_2,iVar7);
            bVar17 = *(int *)(iVar7 + 300) != 7;
            iVar7 = FUN_00105594(iVar7,1);
          }
          else {
            bVar17 = false;
            FUN_0010d4cc(iVar7,param_3);
            FUN_000e7688(uVar6,iVar7);
          }
          ...
          for (piVar15 = (int *)piVar1[2]; piVar15 != (int *)0x0; piVar15 = (int *)piVar15[2]) {
            ...
            if ((iVar3 == 0) && (iVar3 = (**(code **)(*piVar1 + 0x38))(piVar1), iVar3 == 0)) {
              if (*(int *)(piVar1[0x22] + 8) == 0x8e) {
                uVar8 = FUN_00105594(piVar1,1);
                uVar9 = FUN_00105594(piVar1,2);
                iVar3 = FUN_00139034(uVar8,param_1,iVar14,iVar13);
                if (iVar3 == 0) {
                  FUN_0019401c(uVar8);
                  FUN_000e7688(uVar6,uVar8);
                }
                iVar3 = FUN_00139034(uVar9,param_1,iVar14,iVar13);
                if (iVar3 == 0) {
                  FUN_0019401c(uVar9);
                  FUN_000e7688(uVar6,uVar9);
                }
                FUN_0010d730(piVar1,iVar7,uVar10,param_3);
        ...
        if (((((*(int *)(piVar11[0x22] + 8) == 0x12) &&
          ...
          if (uVar30 != 0) {
            do {
              if (uVar25 < *puVar27) {
                if (uVar30 <= uVar25) {
                  _memset(uVar30 * 4 + puVar7[3],0,(uVar25 - uVar30) * 4 + 4);
                  puVar7[2] = uVar25 + 1;
                }
...
LAB_0013ff84:
          uVar32 = ((int (*)())FUN_0013a644)(piVar11);
          uVar30 = puVar7[2];
          if (uVar30 < *puVar27) {
            _memset(uVar30 * 4 + puVar7[3],0,4);
            puVar7[2] = uVar30 + 1;
    ...
    if (puVar7[2] != 0) {
      ...
      do {
        if (uVar30 < local_78) {
          if (local_74 <= uVar30) {
            _memset(local_74 * 4 + local_70,0,(uVar30 - local_74) * 4 + 4);
            local_74 = uVar30 + 1;
          }
        ...
        if (uVar30 < *puVar27) {
          uVar28 = puVar7[2];
          if (uVar28 <= uVar30) {
            _memset(uVar28 * 4 + puVar7[3],0,(uVar30 - uVar28) * 4 + 4);
            puVar7[2] = uVar30 + 1;
            uVar28 = uVar30 + 1;
          }
...
LAB_00140128:
          ...
          if (uVar33 < *puVar27) {
            if (uVar28 <= uVar33) {
              _memset(uVar28 * 4 + puVar7[3],0,(uVar33 - uVar28) * 4 + 4);
              puVar7[2] = uVar30;
            }
          ...
          if (uVar33 < local_78) {
            if (local_74 <= uVar33) {
              _memset(local_74 * 4 + local_70,0,(uVar33 - local_74) * 4 + 4);
              local_74 = uVar30;
            }
          ...
          if (uVar33 < *puVar27) {
            uVar18 = puVar7[2];
            if (uVar18 <= uVar33) {
              _memset(uVar18 * 4 + puVar7[3],0,(uVar33 - uVar18) * 4 + 4);
              puVar7[2] = uVar30;
            }
            ...
            if ((cVar1 == '\0') || ((char)local_80 != '\0')) {
              ...
              if (0 < (int)uVar30) {
                ...
                do {
                  if (uVar33 < *puVar10) {
                    if (uVar30 <= uVar33) {
                      _memset(uVar30 * 4 + puVar10[2],0,(uVar33 - uVar30) * 4 + 4);
                      puVar10[1] = uVar33 + 1;
                    }
              ...
              *(int *)(iVar9 + 8) = iVar14;
              for (iVar9 = 1; iVar13 = (**(code **)(*piVar5 + 0x14))(piVar5), iVar9 <= iVar13;
                ...
                uVar30 = puVar10[1];
                if (uVar30 < *puVar10) {
                  _memset(uVar30 * 4 + puVar10[2],0,4);
            ...
            if (-1 < (int)uVar25) {
              ...
              do {
                if (uVar25 < *puVar10) {
                  uVar33 = puVar10[1];
                  if (uVar33 <= uVar25) {
                    _memset(uVar33 * 4 + puVar10[2],0,(uVar25 - uVar33) * 4 + 4);
                    puVar10[1] = uVar25 + 1;
                  }
