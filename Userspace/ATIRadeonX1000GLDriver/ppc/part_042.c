  ...
  int param_1;
{
  ...
  if (piVar1 != (int *)0x0) {
    ...
    do {
      piVar2 = piVar1;
      iVar5 = *(int *)(piVar3[0x26] + 8);
      iVar7 = piVar3[0x26];
      if (iVar5 != 0) {
        do {
          iVar6 = iVar5;
          iVar5 = ((int (*)())FUN_00139344)(iVar7);
          if (iVar5 != 0) {
            piVar1 = (int *)FUN_00105594(iVar7,1);
            iVar5 = (**(code **)(*piVar1 + 0x4c))(piVar1);
            piVar1 = piVar3;
            if (iVar5 != 0) {
              while (piVar1 != piVar4) {
                iVar5 = (**(code **)(*piVar1 + 0x24))(piVar1);
                if (iVar5 != 0) {
                  if (a0 == (int *)0x0) {
                    FUN_000e79a0(piVar4);
                    a0 = (int *)FUN_000e920c(piVar4,0);
                  ...
                  FUN_0010401c(iVar7);
                  *(uint *)(iVar7 + 0x14) = *(uint *)(iVar7 + 0x14) | 1;
                  FUN_000e7688(a0,iVar7);
                  break;
                }
                iVar5 = (**(code **)(*piVar1 + 0x28))(piVar1);
                if (iVar5 == 0) {
                  iVar5 = (**(code **)(*piVar1 + 0x2c))(piVar1);
                  if (iVar5 == 0) {
                    iVar5 = (**(code **)(*piVar1 + 0x34))(piVar1);
                    if (iVar5 != 0) {
  ...
  int param_4;
{
  ...
  iVar1 = ((undefined4 (*)())FUN_00139838)(param_1,1,(double)FLOAT_001aa0d4);
  if (iVar1 == 0) {
    return 0;
  }
  ...
  if ((*(int *)(iVar1 + 8) == 0x24) && ((*(uint *)(iVar2 + 0x14) & 0x200) == 0)) {
    iVar1 = ((undefined4 (*)())FUN_00139838)(iVar2,2,(double)FLOAT_001aa0d4);
    if ((iVar1 == 0) ||
       (((iVar1 = ((undefined4 (*)())FUN_00139838)(iVar2,3,(double)FLOAT_001aa0e8), iVar1 == 0 ||
...
LAB_00139c2c:
    ...
    if ((*(int *)(iVar1 + 8) == 0x28) && ((*(uint *)(iVar2 + 0x14) & 0x200) == 0)) {
      iVar1 = ((undefined4 (*)())FUN_00139838)(iVar2,1,(double)FLOAT_001aa0d4);
      if ((iVar1 != 0) &&
    ...
    iVar1 = ((undefined4 (*)())FUN_00139838)(iVar2,3,(double)FLOAT_001aa0e8);
    if (iVar1 == 0) {
      return 0;
    }
  ...
  int param_4;
{
  ...
  if (((*(uint *)(param_1 + 0x14) & 1) != 0) &&
    ...
    iVar1 = ((int (*)())FUN_001398b4)(param_1,param_2,param_3,param_4);
    if (iVar1 != 0) {
...
/* FUN_00139d40 @ 0x139d40 (524 bytes) */
  ...
  for (iVar5 = *(int *)(*(int *)(param_1 + 900) + 8); iVar5 != 0; iVar5 = *(int *)(iVar5 + 8)) {
    ...
    if (piVar3 != (int *)0x0) {
      do {
        piVar4 = piVar3;
        if ((piVar9[5] & 1U) != 0) {
          iVar5 = (**(code **)(*piVar9 + 0x30))(piVar9);
          uVar8 = local_44;
          if ((iVar5 != 0) && (*(int *)(param_1 + 0x474) != piVar9[0x54])) {
            piVar9[0x54] = *(int *)(param_1 + 0x474);
            if (local_44 < local_48) {
              iVar5 = local_44 * 4;
              _memset(iVar5 + local_40,0,4);
              local_44 = uVar8 + 1;
              puVar6 = (undefined4 *)(iVar5 + local_40);
            }
            else {
              puVar6 = (undefined4 *)FUN_0019423c(&local_48,local_44);
            }
            *puVar6 = piVar9;
            do {
              uVar8 = local_44 - 1;
              piVar3 = (int *)0x0;
              if (uVar8 < local_44) {
                piVar3 = (int *)(uVar8 * 4 + local_40);
              }
              iVar5 = *piVar3;
              FUN_00194208(&local_48,uVar8);
              if (0 < *(int *)(iVar5 + 0x84)) {
                iVar10 = 1;
                do {
                  iVar7 = FUN_00105594(iVar5,iVar10);
                  uVar8 = local_44;
                  *(uint *)(iVar7 + 0x14) = *(uint *)(iVar7 + 0x14) | 0x2000;
                  if ((iVar7 != 0) && (*(int *)(param_1 + 0x474) != *(int *)(iVar7 + 0x150))) {
                    *(int *)(iVar7 + 0x150) = *(int *)(param_1 + 0x474);
                    if (local_44 < local_48) {
                      iVar1 = local_44 * 4;
                      _memset(iVar1 + local_40,0,4);
                      local_44 = uVar8 + 1;
                      piVar3 = (int *)(iVar1 + local_40);
                    }
                    else {
                      piVar3 = (int *)FUN_0019423c(&local_48,local_44);
                    }
                    *piVar3 = iVar7;
                  }
                  iVar10 = iVar10 + 1;
                } while (iVar10 <= *(int *)(iVar5 + 0x84));
              }
            } while (local_44 != 0);
          }
          piVar4 = (int *)piVar9[2];
  ...
  int param_3;
{
  ...
  iVar10 = param_3;
  iVar5 = (**(code **)(*param_1 + 0x40))(param_1,param_2,param_3);
  if (iVar5 != 0) {
    return;
  }
  uVar6 = FUN_000e7804(param_1,extraout_r4,iVar10,in_r6,in_r7,in_r8,in_r9);
  uVar11 = param_2[1];
  if (uVar11 < *param_2) {
    _memset(uVar11 * 4 + param_2[2],0,4);
    puVar7 = (undefined4 *)(uVar11 * 4 + param_2[2]);
    param_2[1] = uVar11 + 1;
  }
  else {
    puVar7 = (undefined4 *)FUN_0019423c(param_2,uVar11);
  }
  *puVar7 = uVar6;
  bVar1 = 0;
  uVar11 = param_2[1];
  ...
  do {
    ...
    if (uVar11 - 1 < param_2[1]) {
      piVar8 = (int *)((uVar11 - 1) * 4 + param_2[2]);
    }
    iVar10 = *piVar8;
    ...
    if (0 < *(int *)(iVar10 + 0x84)) {
      iVar5 = 1;
      do {
        piVar8 = (int *)FUN_00105594(iVar10,iVar5);
        if (piVar8 != (int *)0x0) {
          iVar9 = (**(code **)(*piVar8 + 0x28))(piVar8);
          if (iVar9 == 0) {
            iVar9 = (**(code **)(*piVar8 + 0x4c))(piVar8);
            if (iVar9 != 0) {
              bVar1 = 1;
            }
          }
          ...
          if ((bool)(bVar2 & bVar1)) {
            iVar9 = param_1[0x4d];
            iVar5 = param_1[0x4e];
            iVar10 = FUN_000e9294(param_1);
            if (iVar10 == 0) goto LAB_0013a198;
            piVar8 = *(int **)(iVar9 + 0x98);
            piVar3 = (int *)(*(int **)(iVar9 + 0x98))[2];
            goto joined_r0x0013a104;
          }
          if (param_3 != piVar8[0x54]) {
            piVar8[0x54] = param_3;
            uVar11 = param_2[1];
            if (uVar11 < *param_2) {
              _memset(uVar11 * 4 + param_2[2],0,4);
...
LAB_0013a220:
  ...
  return;
joined_r0x0013a104:
  if (piVar3 == (int *)0x0) goto LAB_0013a148;
  if ((piVar8[5] & 1U) != 0) {
    iVar10 = (**(code **)(*piVar8 + 0x28))(piVar8);
    if (iVar10 != 0) goto LAB_0013a220;
    piVar3 = (int *)piVar8[2];
  }
  piVar8 = piVar3;
  piVar3 = (int *)piVar3[2];
  ...
  int param_1;
{
  ...
  if (uVar2 != 0) {
    ...
    do {
      if (uVar7 < *puVar9) {
        if (uVar2 <= uVar7) {
          _memset(uVar2 * 4 + puVar9[2],0,(uVar7 - uVar2) * 4 + 4);
          puVar9[1] = uVar7 + 1;
        }
...
int FUN_0013a774(param_1, param_2, param_3)
  int *param_1;
  uint param_2;
  uint param_3;
{
  ...
  if (uVar2 != 0) {
    ...
    do {
      if (uVar4 < *puVar7) {
        if (uVar2 <= uVar4) {
          param_3 = (uVar4 - uVar2) * 4 + 4;
          _memset(uVar2 * 4 + puVar7[2],0,param_3);
          puVar7[1] = uVar4 + 1;
          param_2 = extraout_r4;
        }
        uVar9 = CONCAT44(uVar4 * 4 + puVar7[2],param_2);
      }
      else {
        uVar9 = FUN_0019423c(puVar7,uVar4);
      }
      a1 = (undefined4)uVar9;
      uVar6 = *(undefined4 *)((ulonglong)uVar9 >> 0x20);
      for (iVar8 = 1; iVar3 = (**(code **)(*param_1 + 0x14))(param_1,a1,param_3), iVar8 <= iVar3;
          iVar8 = iVar8 + 1) {
        uVar9 = FUN_00105594(uVar6,iVar8);
        a1 = (undefined4)uVar9;
        if (param_1 == (int *)((ulonglong)uVar9 >> 0x20)) {
          iVar3 = 0;
          do {
            uVar9 = FUN_001054ec(uVar6,iVar8);
            a1 = (undefined4)uVar9;
            uVar2 = (uint)*(byte *)(iVar3 + (int)((ulonglong)uVar9 >> 0x20) + 0x10);
            if ((uVar2 != 4) && (uVar5 = uVar5 & ~(1 << (uVar2 & 0x3f)), uVar5 == 0)) {
              return 0;
            }
            bVar1 = iVar3 != 3;
            iVar3 = iVar3 + 1;
...
LAB_0013ae00:
                *(uint *)(iVar9 + piVar7[0x53] * 4) = local_b8;
                ...
                iVar10 = (**(code **)(*piVar7 + 0x24))(piVar7);
                ...
                if (((((uVar5 != 0) && (bVar2)) && (bVar4)) &&
                   ...
                   (uVar5 = ((int (*)())FUN_0013a774)(piVar7,uVar14,param_1), uVar5 != 0)) {
                  iVar10 = FUN_001054ec(piVar7,0);
                  if (*(char *)(iVar10 + 0x13) == '\x01') {
                    if ((piVar7[5] & 0x200U) != 0) {
                      ...
                      for (; piVar8 != (int *)0x0; piVar8 = (int *)FUN_00105594(piVar8,piVar8[0x21])
                        ...
                        if (*(char *)(iVar10 + 0x13) == '\x01') {
                          uVar5 = ((int (*)())FUN_0013a774)(piVar8,uVar5,param_1);
                          bVar2 = uVar5 == 0;
                        }
                        else {
                  ...
                  *(undefined1 *)((int)piVar20 + uVar5 + 0xc) = 1;
                  ...
                  if (iVar15 == 0) {
                    for (iVar15 = 1; iVar10 = (**(code **)(*piVar20 + 0x14))(piVar20),
                      ...
                      (**(code **)(*piVar20 + 0x88))
                                (piVar20,iVar15,3,4,in_r7,in_r8,*(code **)(*piVar20 + 0x88));
  ...
  int param_2;
{
  ...
  for (uVar8 = 0; iVar6 = FUN_00104054(param_1,param_2), (int)uVar8 < iVar6; uVar8 = uVar8 + 1) {
    ...
    if (uVar8 < *puVar10) {
      uVar3 = puVar10[1];
      if (uVar3 <= uVar8) {
        _memset(uVar3 * 4 + puVar10[2],0,(uVar8 - uVar3) * 4 + 4);
        puVar10[1] = uVar8 + 1;
      }
...
LAB_0013b318:
  ...
  if (((1 < iVar6) && (piVar7 = (int *)FUN_000e9184(piVar7,0), piVar7 == *(int **)(param_1 + 0x158))
      ) || (iVar6 = ((int (*)())FUN_00139294)(piVar7,*(undefined4 *)(param_2 + 0x3a0)), iVar6 == 0)) {
LAB_0013b3c4:
    piVar7 = (int *)0x0;
  }
  return piVar7;
...
/* FUN_0013b3f0 @ 0x13b3f0 (172 bytes) */
  ...
  int param_1;
{
  ...
  *puVar5 = uVar21;
  ...
  for (iVar4 = *(int *)(*(int *)(param_1 + 900) + 8); iVar4 != 0; iVar4 = *(int *)(iVar4 + 8)) {
    if (iVar23 != iVar15) {
      iVar4 = ((int (*)())FUN_00139294)(iVar23,iVar15);
      if (iVar4 != 0) {
...
code_r0x0013b658:
  ...
  if (piVar8 == (int *)0x0) {
    ...
    do {
      ...
      if (iVar4 != 0) goto code_r0x0013ba08;
  ...
  do {
    ...
    if ((iVar4 != 0) && (piVar12 == piVar19)) {
      ...
      for (uVar24 = 1; uVar24 <= *(uint *)(piVar12[0x35] + 4); uVar24 = uVar24 + 1) {
        ...
        if ((piVar2 != (int *)0x0) && (piVar20 != piVar2)) goto code_r0x0013b8e4;
        iVar4 = iVar4 + 4;
      }
      piVar2 = (int *)0x0;
code_r0x0013b8e4:
          ...
          if (iVar23 == 0) {
            for (; iVar23 = FUN_00104054(piVar20,param_1), (int)uVar24 < iVar23; uVar24 = uVar24 + 1
              ...
              if ((piVar22 != *(int **)(*piVar12 + 0x158)) &&
                 (piVar8 != *(int **)(*piVar12 + 0x158))) goto code_r0x0013bd34;
            }
...
code_r0x0013bd34:
  ...
  goto code_r0x0013b658;
}

/* FUN_0013bd68 @ 0x13bd68 (1124 bytes) */
  ...
  int param_2;
{
  ...
  *(int *)(param_1 + 0x2ac) = iVar11 + 1;
  iVar2 = *(int *)(iVar9 + 0x324);
  if (bVar1) {
    iVar6 = 0;
  }
  else {
    iVar6 = FUN_00193e18(*(undefined4 *)(iVar9 + 0x378),iVar2 << 2);
    iVar9 = *(int *)(param_1 + 900);
    for (iVar4 = *(int *)(*(int *)(param_1 + 900) + 8); iVar4 != 0; iVar4 = *(int *)(iVar4 + 8)) {
      iVar3 = *(int *)(*(int *)(iVar9 + 0x98) + 8);
      iVar10 = *(int *)(iVar9 + 0x98);
      if (iVar3 != 0) {
        do {
          iVar4 = iVar3;
          if ((*(uint *)(iVar10 + 0x14) & 1) != 0) {
            iVar4 = *(int *)(iVar10 + 0x160) - *(int *)(param_1 + 0x478);
            if (iVar4 < 0) {
              iVar4 = 0;
            }
            *(int *)(*(int *)(iVar10 + 0x14c) * 4 + iVar6) = iVar4;
            iVar4 = *(int *)(iVar10 + 8);
          }
          iVar3 = *(int *)(iVar4 + 8);
          iVar10 = iVar4;
  ...
  iVar4 = 0;
  *(int *)(param_1 + 0x474) = *(int *)(param_1 + 0x474) + 1;
  *(int *)(param_1 + 0x478) = iVar2 * 4 + *(int *)(param_1 + 0x478);
  local_48 = *(undefined4 *)(iVar9 + 0x378);
  local_54 = 2;
  local_50 = 0;
  local_4c = FUN_00193e18(local_48,8);
  iVar2 = *(int *)(param_1 + 0x3c4);
  for (uVar12 = 1; uVar12 <= *(uint *)(iVar2 + 4); uVar12 = uVar12 + 1) {
    iVar9 = *(int *)(*(int *)(iVar2 + 8) + iVar4);
    if ((*(uint *)(iVar9 + 0x14) & 1) != 0) {
      iVar2 = FUN_001054ec(iVar9,0);
      uVar8 = local_50;
      if ((*(int *)(iVar2 + 0x10) != DAT_001b0014) &&
         (*(int *)(param_1 + 0x474) != *(int *)(iVar9 + 0x150))) {
        *(int *)(iVar9 + 0x150) = *(int *)(param_1 + 0x474);
        if (local_50 < local_54) {
          iVar2 = local_50 * 4;
          _memset(iVar2 + local_4c,0,4);
          local_50 = uVar8 + 1;
          piVar7 = (int *)(iVar2 + local_4c);
        }
        else {
          piVar7 = (int *)FUN_0019423c(&local_54,local_50);
        }
        *piVar7 = iVar9;
        do {
          uVar8 = local_50 - 1;
          piVar7 = (int *)0x0;
          if (uVar8 < local_50) {
            piVar7 = (int *)(uVar8 * 4 + local_4c);
          }
          iVar2 = *piVar7;
          FUN_00194208(&local_54,uVar8);
          if (0 < *(int *)(iVar2 + 0x84)) {
            iVar9 = 1;
            do {
              iVar3 = FUN_00105594(iVar2,iVar9);
              uVar8 = local_50;
              if (iVar3 != 0) {
                if (*(int *)(param_1 + 0x478) < *(int *)(iVar3 + 0x160)) {
                  *(int *)(iVar3 + 0x160) = *(int *)(iVar3 + 0x160) + 1;
                }
                else {
                  *(int *)(iVar3 + 0x160) = *(int *)(param_1 + 0x478) + 1;
                }
                if (*(int *)(param_1 + 0x474) != *(int *)(iVar3 + 0x150)) {
                  *(int *)(iVar3 + 0x150) = *(int *)(param_1 + 0x474);
                  if (local_50 < local_54) {
                    iVar10 = local_50 * 4;
                    _memset(iVar10 + local_4c,0,4);
                    local_50 = uVar8 + 1;
                    piVar7 = (int *)(iVar10 + local_4c);
                  }
                  else {
                    piVar7 = (int *)FUN_0019423c(&local_54,local_50);
                  }
  ...
  if (iVar2 == 0) {
    ...
    do {
      iVar4 = iVar2;
      piVar7 = (int *)(*(int **)(iVar9 + 0x98))[2];
      piVar14 = *(int **)(iVar9 + 0x98);
      if (piVar7 != (int *)0x0) {
        do {
          piVar5 = piVar7;
          if ((piVar14[5] & 1U) != 0) {
            iVar2 = (**(code **)(*piVar14 + 0x34))(piVar14);
            if ((iVar2 == 0) && (iVar2 = (**(code **)(*piVar14 + 0x38))(piVar14), iVar2 == 0)) {
              if ((!bVar1) && (iVar2 = (**(code **)(*piVar14 + 0x48))(piVar14), iVar2 == 0)) {
                iVar2 = piVar14[0x58] - *(int *)(param_1 + 0x478);
                if (iVar2 < 0) {
                  iVar2 = 0;
                }
                if (*(int *)(piVar14[0x53] * 4 + iVar6) != iVar2) {
                  uVar13 = 0;
                }
              }
...
LAB_0013c188:
  ...
  if (!bVar1) {
    FUN_00193cc0(*(undefined4 *)(*(int *)(param_1 + 8) + 0x378),iVar6);
  }
  ...
  int param_1;
{
  ...
  *(int *)(param_1 + 0x474) = *(int *)(param_1 + 0x474) + 1;
  ...
  do {
    uVar11 = local_50;
    if (*(uint *)(iVar2 + 4) < uVar9) {
      FUN_00193cc0(local_38,local_3c);
      FUN_00193cc0(local_48,local_4c);
      return;
    }
    local_58 = *(int *)(*(int *)(iVar2 + 8) + iVar8);
          ...
          if ((local_58 == 0) || (*(int *)(param_1 + 0x474) == *(int *)(local_58 + 0x150))) {
            ...
            *(int *)(local_58 + 0x150) = *(int *)(param_1 + 0x474);
            ...
            if (iVar2 == 0) {
              ...
              uVar10 = *puVar3;
LAB_0013c528:
              uVar6 = ((int (*)())FUN_0013922c)(&local_44);
              ((int (*)())FUN_00139c78)(local_58,uVar10,uVar6,param_1);
              goto LAB_0013c540;
            }
            if (local_50 < local_54) {
              iVar2 = local_50 * 4;
            ...
            *piVar4 = local_58;
            uVar10 = ((int (*)())FUN_0013a38c)(local_58,&local_44,param_1);
LAB_0013c54c:
            local_58 = FUN_00105594(local_58,uVar10);
            bVar1 = true;
            uVar11 = local_50;
          }
        }
          ...
          if (iVar2 != 0) {
            if (local_58 != 0) {
              ...
              uVar11 = local_50;
              if (iVar5 == 0) {
                uVar10 = ((int (*)())FUN_0013a240)(&local_44);
                local_58 = iVar2;
                goto LAB_0013c54c;
              }
            }
            FUN_00194208(&local_54,uVar11 - 1);
    ...
    do {
      ...
      if (bVar2) {
        if (local_58 != 0) {
          ...
          if (iVar8 != 0) {
            local_58 = FUN_00147f54(local_58,*(undefined4 *)(param_1 + 8));
          }
          uVar6 = local_50;
      ...
      if (iVar8 == 0) {
        ...
        if (local_58 != 0) {
          ...
          if (*piVar5 != *(int *)(iVar8 + 0x84)) {
            ...
            iVar11 = *piVar5;
            FUN_00194208(&local_44,uVar6);
            uVar6 = local_40;
            if (local_40 < local_44) {
              iVar1 = local_40 * 4;
              _memset(iVar1 + local_3c,0,4);
              local_40 = uVar6 + 1;
  ...
  int *param_1;
{
  ...
  if (*(int *)(param_1[0x22] + 8) == 0x8e) {
    iVar2 = (**(code **)(*param_1 + 0x7c))(param_1);
  ...
  uint param_3;
{
  ...
  if (iVar3 != 0) {
    uVar18 = (**(code **)(*param_1 + 0x40))(param_1);
    if ((int)((ulonglong)uVar18 >> 0x20) == 0) {
      uVar18 = FUN_000e7804(param_1,(int)uVar18,uVar9,in_r6,in_r7,in_r8,in_r9);
      if ((*(int *)(*(int *)((int)((ulonglong)uVar18 >> 0x20) + 0x88) + 8) == 0x8b) ||
         (iVar3 = FUN_000e7804(param_1,(int)uVar18,uVar9,in_r6,in_r7,in_r8,in_r9),
         *(int *)(*(int *)(iVar3 + 0x88) + 8) == 0x8c)) {
        iVar3 = param_1[0x4f];
        uVar14 = param_1[0x4d];
        iVar13 = param_1[0x4e];
        piVar15 = *(int **)(iVar3 + 0x98);
        ...
        if (piVar1 == (int *)0x0) {
          ...
          do {
            piVar2 = piVar1;
            in_r9 = (int *)(piVar15[5] & 1);
            if (in_r9 != (int *)0x0) {
              iVar5 = (**(code **)(*piVar15 + 0x34))(piVar15);
              if (((iVar5 == 0) && (iVar5 = (**(code **)(*piVar15 + 0x38))(piVar15), iVar5 == 0)) &&
                 (*(int *)(piVar15[0x22] + 8) == 0x8e)) {
                piVar1 = (int *)FUN_00105594(piVar15,1);
                iVar11 = iVar11 + 1;
                if ((uVar14 == piVar1[0x56]) &&
                   (iVar5 = (**(code **)(*piVar1 + 100))(piVar1), iVar5 != 0)) {
                  for (iVar5 = 1; iVar4 = (**(code **)(*piVar1 + 0x14))(piVar1), iVar5 <= iVar4;
                      iVar5 = iVar5 + 1) {
                    if ((((piVar1[iVar5 * 6 + 0x28] & 1U) != 0) ||
                        (in_r9 = (int *)(piVar1[iVar5 * 6 + 0x28] & 2), in_r9 != (int *)0x0)) ||
                  ...
                  if (((iVar5 != 0) || ((piVar1[5] & 2U) != 0)) ||
                     ((in_r9 = (int *)(piVar1[5] & 0x200), in_r9 != (int *)0x0 ||
                      (*(int *)(piVar1[4] + 4) != 1)))) goto LAB_0013cd68;
                  iVar16 = iVar16 + 1;
                  bVar17 = true;
                }
                else {
LAB_0013cd68:
                  uVar9 = uVar14;
                  in_r6 = iVar13;
                  iVar5 = FUN_00139034(piVar1,param_1,uVar14,iVar13);
                  bVar17 = iVar5 != 0;
                }
                piVar1 = (int *)FUN_00105594(piVar15,2);
                if ((iVar13 == piVar1[0x56]) &&
                   (iVar5 = (**(code **)(*piVar1 + 100))(piVar1), iVar5 != 0)) {
                  for (iVar5 = 1; iVar4 = (**(code **)(*piVar1 + 0x14))(piVar1), iVar5 <= iVar4;
                      iVar5 = iVar5 + 1) {
                    if ((((piVar1[iVar5 * 6 + 0x28] & 1U) != 0) ||
...
LAB_0013cee8:
        ...
        iVar5 = FUN_00194034(uVar14 + 0x90);
        if (((iVar16 == iVar5) && (iVar16 = FUN_00194034(iVar13 + 0x90), iVar16 == iVar12 + 2)) &&
           (iVar11 != 0)) {
          uVar18 = FUN_000e9184(param_1,0);
          uVar6 = (undefined4)((ulonglong)uVar18 >> 0x20);
          iVar11 = FUN_000e7804(param_1,(int)uVar18,uVar9,in_r6,in_r7,in_r8,in_r9);
          uVar10 = 0;
          if (*(int *)(*(int *)(iVar11 + 0x88) + 8) == 0x8c) {
            iVar12 = FUN_001054ec(iVar11,1);
            uVar10 = *(undefined4 *)(iVar12 + 0x10);
            FUN_000ef970(param_2,iVar11);
            bVar17 = *(int *)(iVar11 + 300) != 7;
            iVar11 = FUN_00105594(iVar11,1);
          }
          else {
            bVar17 = false;
            FUN_0010d4cc(iVar11,param_3);
            FUN_000e7688(uVar6,iVar11);
          }
          piVar1 = *(int **)(iVar3 + 0x98);
          for (piVar15 = (int *)piVar1[2]; piVar15 != (int *)0x0; piVar15 = (int *)piVar15[2]) {
            ...
            if ((iVar3 == 0) && (iVar3 = (**(code **)(*piVar1 + 0x38))(piVar1), iVar3 == 0)) {
              if (*(int *)(piVar1[0x22] + 8) == 0x8e) {
                ...
                iVar3 = FUN_00139034(uVar7,param_1,uVar14,iVar13);
                if (iVar3 == 0) {
                  FUN_0019401c(uVar7);
                  FUN_000e7688(uVar6,uVar7);
                }
                iVar3 = FUN_00139034(uVar8,param_1,uVar14,iVar13);
                if (iVar3 == 0) {
                  FUN_0019401c(uVar8);
                  FUN_000e7688(uVar6,uVar8);
                }
                FUN_0010d730(piVar1,iVar11,uVar10,param_3);
                if ((*(int *)(piVar1[0x22] + 8) != 0x31) && (bVar17)) {
...
/* FUN_0013d160 @ 0x13d160 (376 bytes) */
          ...
          if (((iVar5 != 0) && (piVar10[0x20] != 0)) &&
            ...
            if (iVar5 == 0) {
              ...
              if (iVar5 != 0) {
                ...
                if (iVar5 == 0) {
                  iVar5 = FUN_0010445c(piVar10,*(undefined4 *)(param_1 + 8),0);
                  *(uint *)(iVar5 + 0x9c) = uVar9 & 0xffffff00 | 1;
                  uVar8 = *(undefined4 *)(iVar5 + 0x14c);
                  iVar6 = FUN_001054ec(iVar5,0);
                  *(undefined4 *)(iVar6 + 8) = uVar8;
                  piVar10[0x27] = 0x1010100;
                  FUN_00106804(piVar10,iVar5,0,*(undefined4 *)(param_1 + 8));
                  FUN_000e7700(iVar2,piVar10,iVar5);
                  for (iVar5 = 1; iVar6 = (**(code **)(*piVar10 + 0x14))(piVar10), iVar5 <= iVar6;
                      iVar5 = iVar5 + 1) {
                    piVar3 = (int *)FUN_00105594(piVar10,iVar5);
                    iVar6 = (**(code **)(*piVar3 + 0x5c))(piVar3);
                    if (iVar6 != 0) {
                      iVar6 = FUN_0010445c(piVar3,*(undefined4 *)(param_1 + 8),0);
...
/* FUN_0013da3c @ 0x13da3c (760 bytes) */
  ...
  int param_1;
{
  ...
  if (uVar6 == 0) {
    ...
    while (local_a0 != 0) {
      ...
      if (uVar6 < local_a0) {
        puVar9 = (undefined4 *)(uVar6 * 4 + local_9c);
      }
      uVar19 = *puVar9;
      FUN_00194208(&local_a4,uVar6);
                        ...
                        if (iVar12 == 0) {
                          ...
                          if (piVar7 != (int *)0x0) {
                            if (((((piVar7[0x20] != 0) &&
                              ...
                              ((int (*)())FUN_001396a0)(piVar7,piVar20);
                              goto code_r0x0013e80c;
                            }
                            puVar21 = (uint *)piVar7[4];
                            uVar6 = puVar21[1];
                            if (uVar6 < *puVar21) {
                  ...
                  if ((piVar20[5] & 0x200U) != 0) {
                    ...
                    if (iVar17 == 0) {
                      ...
                      if (piVar20[0x21] == 0) {
                        ...
                        iVar23 = FUN_001054ec(piVar20,piVar20[0x21]);
                        ...
                        if (uVar6 != 0) {
                          ...
                          do {
                            if (uVar22 < *puVar21) {
                              puVar24 = puVar21;
                              if (uVar6 <= uVar22) {
                                _memset(uVar6 * 4 + puVar21[2],0,(uVar22 - uVar6) * 4 + 4);
                                puVar21[1] = uVar22 + 1;
        ...
        *(int *)(param_1 + 0x474) = *(int *)(param_1 + 0x474) + 1;
        ...
        do {
          do {
            ...
            piVar7 = (int *)0x0;
            if (uVar6 < local_b0) {
              piVar7 = (int *)(uVar6 * 4 + local_ac);
            }
            iVar17 = *piVar7;
            FUN_00194208(&local_b4,uVar6);
...
code_r0x0013f320:
                    ...
                    if ((*(char *)((int)&local_c0 + iVar8) != '\0') &&
                      ...
                      if (*(char *)((int)&local_c8 + iVar8) == '\x04') {
                        *(char *)((int)&local_c8 + iVar8) = (char)iVar8;
                        ...
                        if (piVar20 != (int *)0x0) goto code_r0x0013f320;
                      }
                    }
                  }
                  bVar1 = iVar8 != 3;
      ...
      puVar9 = (undefined4 *)0x0;
      if (uVar6 < local_b0) {
        puVar9 = (undefined4 *)(uVar6 * 4 + local_ac);
      }
      piVar7 = (int *)*puVar9;
      FUN_00194208(&local_b4,uVar6);
    ...
    do {
      ...
      if (piVar20 != (int *)0x0) {
        if ((((piVar20[0x20] == 0) || (iVar23 = FUN_00126760(piVar20[0x26]), iVar23 == 0)) ||
          ...
          bVar1 = false;
          if (iVar23 != 0) goto code_r0x0013e0ac;
        }
        else {
code_r0x0013e0ac:
          bVar1 = true;
            ...
            if (-1 < (int)uVar18) {
              ...
              do {
                if (uVar18 < *puVar19) {
                  uVar10 = puVar19[1];
                  if (uVar10 <= uVar18) {
                    _memset(uVar10 * 4 + puVar19[2],0,(uVar18 - uVar10) * 4 + 4);
                    puVar19[1] = uVar18 + 1;
                  }
...
LAB_0013fad0:
            ...
            if (0 < (int)uVar3) {
              ...
              do {
                if (uVar18 < *puVar19) {
                  if (uVar3 <= uVar18) {
                    _memset(uVar3 * 4 + puVar19[2],0,(uVar18 - uVar3) * 4 + 4);
                    puVar19[1] = uVar18 + 1;
                  }
  ...
  int param_1;
{
  ...
  puVar7 = (undefined4 *)FUN_00193e18(uVar34,0x14);
  puVar28 = puVar7 + 1;
  *puVar7 = uVar34;
  puVar7[1] = 2;
  puVar7[4] = uVar34;
  puVar7[2] = 0;
  uVar34 = FUN_00193e18(uVar34,8);
  puVar7[3] = uVar34;
  uVar34 = *(undefined4 *)(*(int *)(param_1 + 8) + 0x378);
  puVar8 = (undefined4 *)FUN_00193e18(uVar34,0x14);
  *puVar8 = uVar34;
  puVar8[1] = 2;
  puVar8[4] = uVar34;
  puVar8[2] = 0;
    ...
    for (piVar5 = (int *)(*(int **)(iVar25 + 0x98))[2]; piVar5 != (int *)0x0;
      ...
      if ((piVar11[5] & 1U) != 0) {
        ...
        if (((*(int *)(piVar11[0x22] + 8) == 0x12) &&
            (iVar9 = ((int (*)())FUN_0013f3d4)(piVar11,param_1), iVar9 != 0)) && (iVar4 != 0x1010101)) {
          if (iVar6 == 0) {
            if (iVar4 != 0) goto LAB_0013fe30;
          }
          else if ((iVar4 != 0x1010100) && (iVar4 != 1)) {
LAB_0013fe30:
            uVar32 = puVar7[2];
            uVar26 = 0;
            if (uVar32 != 0) {
              do {
                if (uVar26 < *puVar28) {
                  if (uVar32 <= uVar26) {
                    _memset(uVar32 * 4 + puVar7[3],0,(uVar26 - uVar32) * 4 + 4);
                    puVar7[2] = uVar26 + 1;
                  }
                  piVar5 = (int *)(uVar26 * 4 + puVar7[3]);
                }
                else {
                  piVar5 = (int *)FUN_0019423c(puVar28,uVar26);
                }
                iVar4 = *piVar5;
                for (iVar9 = 1; iVar13 = (**(code **)(*piVar11 + 0x14))(piVar11), iVar9 <= iVar13;
                  ...
                  if (iVar4 == iVar13) {
                    uVar32 = puVar7[2];
                    if (uVar32 < *puVar28) {
                      _memset(uVar32 * 4 + puVar7[3],0,4);
                      puVar7[2] = uVar32 + 1;
                      puVar12 = (undefined4 *)(uVar32 * 4 + puVar7[3]);
                    }
                    else {
                      puVar12 = (undefined4 *)FUN_0019423c(puVar28,uVar32);
                    }
                    *puVar12 = 0;
                    if (local_74 < local_78) {
                      ...
                      *(undefined4 *)(iVar4 + local_70) = 0;
                      ...
                      puVar12 = (undefined4 *)FUN_0019423c(&local_78,local_74);
                    }
                    *puVar12 = 0;
                    goto LAB_0013ff84;
                  }
...
LAB_0013ff84:
            uVar34 = ((int (*)())FUN_0013a644)(piVar11);
            uVar32 = puVar7[2];
            if (uVar32 < *puVar28) {
              _memset(uVar32 * 4 + puVar7[3],0,4);
              puVar7[2] = uVar32 + 1;
              piVar5 = (int *)(uVar32 * 4 + puVar7[3]);
            }
            else {
              piVar5 = (int *)FUN_0019423c(puVar28,uVar32);
            }
            *piVar5 = (int)piVar11;
            if (local_74 < local_78) {
              iVar4 = local_74 * 4;
...
LAB_00140024:
    ...
    if (puVar7[2] != 0) {
      ...
      do {
        if (uVar32 < local_78) {
          if (local_74 <= uVar32) {
            _memset(local_74 * 4 + local_70,0,(uVar32 - local_74) * 4 + 4);
            local_74 = uVar32 + 1;
          }
          puVar10 = (uint *)(uVar32 * 4 + local_70);
        }
        else {
          puVar10 = (uint *)FUN_0019423c(&local_78,uVar32);
        }
        uVar26 = *puVar10;
        if (uVar32 < *puVar28) {
          uVar29 = puVar7[2];
          if (uVar29 <= uVar32) {
            _memset(uVar29 * 4 + puVar7[3],0,(uVar32 - uVar29) * 4 + 4);
            puVar7[2] = uVar32 + 1;
            uVar29 = uVar32 + 1;
          }
          piVar11 = (int *)(uVar32 * 4 + puVar7[3]);
        }
        else {
          piVar11 = (int *)FUN_0019423c(puVar28,uVar32);
          uVar29 = puVar7[2];
        }
        uVar27 = uVar32 + 1;
        iVar4 = *piVar11;
        if ((iVar4 != 0) && (uVar27 < uVar29)) {
          iVar9 = uVar27 * 4;
          uVar32 = uVar32 + 2;
LAB_00140128:
          uVar35 = uVar32 - 1;
          if (uVar35 < *puVar28) {
            if (uVar29 <= uVar35) {
              _memset(uVar29 * 4 + puVar7[3],0,(uVar35 - uVar29) * 4 + 4);
              puVar7[2] = uVar32;
            }
            puVar12 = (undefined4 *)(iVar9 + puVar7[3]);
          }
          else {
            puVar12 = (undefined4 *)FUN_0019423c(puVar28,uVar35);
          }
          piVar11 = (int *)*puVar12;
          if (piVar11 == (int *)0x0) goto LAB_00140d38;
          if (uVar35 < local_78) {
            if (local_74 <= uVar35) {
              _memset(local_74 * 4 + local_70,0,(uVar35 - local_74) * 4 + 4);
              local_74 = uVar32;
            }
            puVar10 = (uint *)(iVar9 + local_70);
          }
          else {
            puVar10 = (uint *)FUN_0019423c(&local_78,uVar35);
          }
          uVar29 = *puVar10;
          iVar13 = FUN_00139008(uVar26);
          iVar14 = FUN_00139008(uVar29);
          ...
          iVar21 = ((uint)piVar11[0x2e] >> 1 & 1) + (piVar11[0x2e] & 1U) * 2;
          iVar23 = (*(uint *)(iVar4 + 0xd0) >> 1 & 1) + (*(uint *)(iVar4 + 0xd0) & 1) * 2;
          iVar14 = ((uint)piVar11[0x34] >> 1 & 1) + (piVar11[0x34] & 1U) * 2;
          if ((piVar15 != piVar16) || (bVar20 = true, iVar13 != iVar21)) {
            bVar20 = false;
          }
          if ((piVar15 != piVar17) || (bVar2 = true, iVar13 != iVar14)) {
            bVar2 = false;
          }
          if ((piVar5 != piVar16) || (bVar22 = true, iVar23 != iVar21)) {
            bVar22 = false;
          }
          if ((piVar5 != piVar17) || (bVar3 = true, iVar23 != iVar14)) {
            bVar3 = false;
          }
          piVar31 = piVar17;
          if ((((!bVar20) && (piVar31 = piVar16, !bVar2)) &&
              (piVar5 = piVar15, piVar31 = piVar17, !bVar22)) && (piVar31 = piVar16, !bVar3))
          goto LAB_00140dc4;
          iVar9 = (**(code **)(*piVar5 + 0x60))(piVar5);
          if (iVar9 != 0) {
            piVar5 = (int *)FUN_00105594(piVar5,1);
          }
          iVar9 = (**(code **)(*piVar31 + 0x60))(piVar31);
          if (iVar9 == 0) {
            piVar15 = piVar31;
            piVar31 = (int *)0x0;
          }
          else {
            piVar15 = (int *)FUN_00105594(piVar31,1);
          }
          ...
          if (uVar35 < *puVar28) {
            uVar18 = puVar7[2];
            if (uVar18 <= uVar35) {
              _memset(uVar18 * 4 + puVar7[3],0,(uVar35 - uVar18) * 4 + 4);
              puVar7[2] = uVar32;
            }
            puVar12 = (undefined4 *)(uVar35 * 4 + puVar7[3]);
          }
          else {
            puVar12 = (undefined4 *)FUN_0019423c(puVar28,uVar35);
          }
          *puVar12 = 0;
          ...
          if ((uVar26 & uVar29) == 0) {
            ...
            *(undefined4 *)(iVar4 + 0x10) = 0x4040404;
            uVar32 = 0;
            do {
              if (((int)uVar26 >> (uVar32 & 0x3f) & 1U) != 0) {
                (**(code **)(*piVar11 + 0x88))(piVar11,piVar11[0x21],uVar32,uVar32);
              }
              bVar20 = uVar32 != 3;
              uVar32 = uVar32 + 1;
            } while (bVar20);
            ...
            *(int *)(param_1 + 0x278) = *(int *)(param_1 + 0x278) + 1;
            uVar34 = 0;
            do {
              if ((((int)(uVar26 & uVar29) >> (uVar35 & 0x3f) & 1U) != 0) && ((int)uVar18 < 4)) {
                uVar24 = uVar18;
                if (((int)uVar32 >> (uVar18 & 0x3f) & 1U) == 0) {
                  iVar9 = 4 - uVar18;
                  do {
                    uVar18 = uVar18 + 1;
                    iVar9 = iVar9 + -1;
                    ...
                    uVar24 = uVar18;
                  } while (((int)uVar32 >> (uVar18 & 0x3f) & 1U) == 0);
                }
            ...
            if ((cVar1 == '\0') || ((char)local_80 != '\0')) {
              ...
              if (0 < (int)uVar32) {
                ...
                do {
                  if (uVar35 < *puVar10) {
                    if (uVar32 <= uVar35) {
                      _memset(uVar32 * 4 + puVar10[2],0,(uVar35 - uVar32) * 4 + 4);
                      puVar10[1] = uVar35 + 1;
                    }
                    piVar5 = (int *)(uVar35 * 4 + puVar10[2]);
                  }
                  else {
                    piVar5 = (int *)FUN_0019423c(puVar10,uVar35);
                  }
                  if ((int *)*piVar5 == piVar11) {
                    FUN_00194208(puVar10,uVar35);
                    iVar9 = FUN_00105594(piVar11,piVar11[0x21]);
              ...
              FUN_00106004(piVar11,piVar11[0x21],0,1,puVar12);
              iVar9 = piVar11[0x21];
              piVar11[0x21] = iVar9 + -1;
              piVar11[5] = piVar11[5] & 0xfffffdff;
              iVar9 = FUN_001054ec(piVar11,iVar9 + -1);
              uVar33 = *(undefined4 *)(iVar9 + 0x10);
              piVar5 = (int *)FUN_0010445c(piVar11,*(undefined4 *)(param_1 + 8),0);
              uVar30 = *(undefined4 *)(*(int *)(param_1 + 8) + 0x378);
              puVar19 = (undefined4 *)FUN_00193e18(uVar30,0x14);
              puVar19[1] = 2;
              *puVar19 = uVar30;
              puVar19[2] = 0;
              puVar19[4] = uVar30;
              uVar30 = FUN_00193e18(uVar30,8);
              puVar19[3] = uVar30;
              piVar5[4] = (int)(puVar19 + 1);
              piVar5[0x58] = *(int *)(*(int *)(*(int *)(param_1 + 8) + 0x6c4) + 0x478);
              FUN_00106804(piVar11,iVar4,1,*(undefined4 *)(param_1 + 8));
              iVar9 = FUN_001054ec(piVar11,piVar11[0x21]);
              *(undefined4 *)(iVar9 + 0x10) = uVar33;
              *(undefined1 *)((int)piVar11 + 0x9f) = 1;
              piVar5[0x27] = 0x1010100;
              ...
              *(undefined4 *)(iVar9 + 0x10) = 0x4040404;
              uVar32 = 0;
              do {
                if ((((int)uVar29 >> (uVar32 & 0x3f) & 1U) != 0) && (uVar32 != 3)) {
              ...
              *(int *)(iVar9 + 8) = iVar14;
              for (iVar9 = 1; iVar13 = (**(code **)(*piVar5 + 0x14))(piVar5), iVar9 <= iVar13;
                ...
                uVar32 = puVar10[1];
                if (uVar32 < *puVar10) {
                  _memset(uVar32 * 4 + puVar10[2],0,4);
                  puVar19 = (undefined4 *)(uVar32 * 4 + puVar10[2]);
                  puVar10[1] = uVar32 + 1;
                }
                else {
                  puVar19 = (undefined4 *)FUN_0019423c(puVar10,uVar32);
                }
                *puVar19 = piVar5;
              }
            }
            ...
            for (iVar9 = 1; iVar13 = (**(code **)(*piVar11 + 0x14))(piVar11), iVar9 <= iVar13;
              ...
              do {
                if (*(char *)((int)&local_80 + iVar21) == '\0') {
                  ...
                  (**(code **)(*piVar11 + 0x88))(piVar11,iVar9,iVar21,4);
                  if (piVar5 != (int *)0x0) {
                    (**(code **)(*piVar5 + 0x88))(piVar5,iVar9,iVar21,4);
                  }
                }
                bVar20 = iVar21 != 3;
                iVar21 = iVar21 + 1;
            ...
            if (-1 < (int)uVar26) {
              ...
              do {
                if (uVar26 < *puVar10) {
                  uVar35 = puVar10[1];
                  if (uVar35 <= uVar26) {
                    _memset(uVar35 * 4 + puVar10[2],0,(uVar26 - uVar35) * 4 + 4);
                    puVar10[1] = uVar26 + 1;
                  }
                  puVar12 = (undefined4 *)(iVar9 + puVar10[2]);
                }
                else {
                  puVar12 = (undefined4 *)FUN_0019423c(puVar10,uVar26);
                }
                piVar15 = (int *)*puVar12;
                iVar13 = 1;
LAB_00140c04:
                ...
                if (iVar13 <= iVar14) {
                  ...
                  iVar14 = 0;
                  do {
                    iVar21 = FUN_001054ec(piVar15,iVar13);
...
LAB_00140dc4:
  uVar29 = puVar7[2];
  iVar9 = iVar9 + 4;
  bVar20 = uVar29 <= uVar32;
  uVar32 = uVar32 + 1;
  if (bVar20) goto LAB_00140d3c;
  goto LAB_00140128;
LAB_00140c00:
  iVar13 = iVar13 + 1;
  goto LAB_00140c04;
  ...
  int *param_3;
{
  ...
  if ((((((*(int *)(param_2[0x22] + 8) == *(int *)(param_3[0x22] + 8)) &&
         (iVar1 = FUN_0011379c(*param_1,param_2), iVar1 != 0)) &&
  ...
  if (iVar1 == 0) {
    ...
    if (uVar4 != 0) {
      ...
      do {
        if (uVar7 < *puVar8) {
          if (uVar4 <= uVar7) {
            _memset(uVar4 * 4 + puVar8[2],0,(uVar7 - uVar4) * 4 + 4);
            puVar8[1] = uVar7 + 1;
          }
        ...
        if ((*piVar5 != 0) && (iVar1 = FUN_00104800(param_2,*piVar5), iVar1 == 0)) {
          return 0;
        }
        puVar8 = *(uint **)(param_3 + 0x10);
        uVar7 = uVar7 + 1;
  ...
  undefined4 *param_4;
{
  ...
  iVar1 = ((int (*)())FUN_001416b4)(param_1,param_2,param_3,0);
  if (iVar1 == 0) {
...
LAB_00141b90:
              ...
              *pbVar13 = (byte)uVar7;
              ...
              while( true ) {
                ...
                uVar22 = (uint)*pbVar18;
                if ((uVar20 != uVar22) &&
                   ((piVar16[0x53] < piVar14[0x53] ||
                    ((piVar14[0x53] == piVar16[0x53] && (uVar21 < uVar22)))))) {
                  *(int **)pbVar17 = piVar16;
                  *pbVar18 = (byte)uVar21;
                  uVar21 = uVar22;
                  piVar16 = piVar14;
            ...
            if (piVar16 != (int *)0x0) goto LAB_00141ae0;
            piVar10[4] = (int)piVar4;
            *piVar10 = 1;
            *pbVar13 = (byte)uVar7;
          }
...
LAB_00141d00:
              ...
              *pbVar13 = (byte)uVar7;
              ...
              while( true ) {
                ...
                uVar22 = (uint)*pbVar18;
                if ((uVar20 != uVar22) &&
                   ((piVar10[0x53] < piVar16[0x53] ||
                    ((piVar16[0x53] == piVar10[0x53] && (uVar21 < uVar22)))))) {
                  *(int **)pbVar17 = piVar10;
                  *pbVar18 = (byte)uVar21;
                  uVar21 = uVar22;
                  piVar10 = piVar16;
              ...
              *(undefined4 *)(param_1 + 0x18) = uVar8;
              if (*(int *)(param_1 + 0x10) != 0) {
                ...
                do {
                  iVar11 = iVar23 + iVar6;
                  uVar22 = uVar22 + 1;
                  iVar9 = iVar23 + *(int *)(param_1 + 0x18);
                  iVar23 = iVar23 + 0x2c;
                  _memcpy(iVar9,iVar11,0x2c);
            ...
            do {
              if (*(int *)pbVar13 != 0) {
                ...
                while ((*(int *)pbVar13 != piVar5[4] ||
                  ...
                  piVar5 = piVar5 + 1;
                  iVar11 = iVar11 + -1;
                  if (iVar11 == 0) goto LAB_00142744;
                }
                if ((iVar9 == -1) ||
                   ((*(int *)(pbVar13 + -0x10) != 0 && ((iVar9 != iVar23 || (piVar4[iVar9] == 0)))))
                   ) break;
              }
              bVar1 = iVar23 == 3;
              pbVar13 = pbVar13 + 4;
      ...
      if (*(uint *)(param_1 + 0x14) < uVar20) {
        ...
        *(undefined4 *)(param_1 + 0x18) = uVar8;
        if (*(int *)(param_1 + 0x10) != 0) {
          ...
          do {
            uVar22 = uVar22 + 1;
            _memcpy(iVar9 + *(int *)(param_1 + 0x18),iVar9 + iVar6,0x2c);
            iVar9 = iVar9 + 0x2c;
          } while (uVar22 < *(uint *)(param_1 + 0x10));
        }
        FUN_00193cc0(*puVar24,iVar6);
    ...
    if (*(uint *)(param_1 + 0x14) < uVar21) {
      ...
      *(undefined4 *)(param_1 + 0x18) = uVar8;
      if (*(int *)(param_1 + 0x10) != 0) {
        ...
        do {
          uVar20 = uVar20 + 1;
          _memcpy(iVar23 + *(int *)(param_1 + 0x18),iVar23 + iVar6,0x2c);
          iVar23 = iVar23 + 0x2c;
  ...
  if (piVar5 != piVar10) {
    ...
    do {
      ...
      if (uVar7 != 4) {
        ...
        pbVar18 = pbVar17;
        do {
          if ((piVar5 == *(int **)pbVar13) && (uVar7 == *pbVar18)) goto LAB_001421bc;
          pbVar13 = pbVar13 + 4;
          pbVar18 = pbVar18 + 1;
          iVar23 = iVar23 + -1;
        } while (iVar23 != 0);
        ...
        while( true ) {
          ...
          if ((uVar21 != uVar20) &&
             ((piVar16[0x53] < piVar14[0x53] ||
              ((piVar14[0x53] == piVar16[0x53] && (uVar7 < uVar20)))))) {
            *(int **)pbVar15 = piVar16;
            *pbVar17 = (byte)uVar7;
            uVar7 = uVar20;
            piVar16 = piVar14;
...
LAB_0014225c:
    ...
    do {
      ...
      if (uVar7 != 4) {
        ...
        pbVar18 = pbVar17;
        do {
          if ((piVar10 == *(int **)pbVar13) && (uVar7 == *pbVar18)) goto LAB_001422b0;
          pbVar13 = pbVar13 + 4;
          pbVar18 = pbVar18 + 1;
          iVar23 = iVar23 + -1;
        } while (iVar23 != 0);
        ...
        while( true ) {
          ...
          uVar20 = (uint)*pbVar17;
          if ((uVar21 != uVar20) &&
             ((piVar5[0x53] < piVar16[0x53] || ((piVar16[0x53] == piVar5[0x53] && (uVar7 < uVar20)))
              ))) {
            *(int **)pbVar15 = piVar5;
            *pbVar17 = (byte)uVar7;
            uVar7 = uVar20;
          ...
          if (*(uint *)(param_1 + 0x14) < uVar21) {
            ...
            *(undefined4 *)(param_1 + 0x18) = uVar8;
            if (*(int *)(param_1 + 0x10) != 0) {
              ...
              do {
                uVar22 = uVar22 + 1;
                _memcpy(*(int *)(param_1 + 0x18) + iVar9,iVar23 + iVar9,0x2c);
                iVar9 = iVar9 + 0x2c;
              } while (uVar22 < *(uint *)(param_1 + 0x10));
            }
          ...
          do {
            if (*(int *)pbVar13 != 0) {
              ...
              while ((*(int *)pbVar13 != piVar10[4] ||
                ...
                piVar10 = piVar10 + 1;
                iVar26 = iVar26 + -1;
                if (iVar26 == 0) goto LAB_00142780;
              }
              if ((iVar11 == -1) ||
                 ((*(int *)(pbVar13 + -0x10) != 0 && ((iVar11 != iVar9 || (piVar5[iVar11] == 0))))))
              break;
            }
            bVar1 = iVar9 == 3;
            pbVar13 = pbVar13 + 4;
        ...
        *(undefined4 *)(param_1 + 0x18) = uVar8;
        if (*(int *)(param_1 + 0x10) != 0) {
          ...
          do {
            ...
            uVar22 = uVar22 + 1;
            iVar26 = iVar11 + *(int *)(param_1 + 0x18);
            iVar11 = iVar11 + 0x2c;
            _memcpy(iVar26,iVar12,0x2c);
          } while (uVar22 < *(uint *)(param_1 + 0x10));
        }
        FUN_00193cc0(*puVar24,iVar23);
        iVar23 = *(int *)(param_1 + 0x18);
      ...
      *(undefined4 *)(param_1 + 0x18) = uVar8;
      if (*(int *)(param_1 + 0x10) != 0) {
        ...
        do {
          iVar26 = iVar23 + iVar9;
          uVar20 = uVar20 + 1;
          iVar11 = *(int *)(param_1 + 0x18) + iVar9;
          iVar9 = iVar9 + 0x2c;
          _memcpy(iVar11,iVar26,0x2c);
        } while (uVar20 < *(uint *)(param_1 + 0x10));
      }
      FUN_00193cc0(*puVar24,iVar23);
      iVar23 = *(int *)(param_1 + 0x18);
    ...
    *param_1 = local_38;
    ...
    if (uVar4 != 0) {
      ...
      do {
        if (uVar8 < *puVar6) {
          if (uVar4 <= uVar8) {
            _memset(uVar4 * 4 + puVar6[2],0,(uVar8 - uVar4) * 4 + 4);
            puVar6[1] = uVar8 + 1;
          }
...
/* FUN_00142974 @ 0x142974 (1532 bytes) */
      ...
      do {
        if (uVar9 < uVar10) {
          if (uVar10 < *puVar11) {
            ...
            puVar12 = puVar11;
            if (uVar1 <= uVar10) {
              _memset(uVar1 * 4 + puVar11[2],0,(uVar10 - uVar1) * 4 + 4);
              puVar11[1] = uVar5;
          ...
          if (uVar9 < *puVar12) {
            ...
            puVar11 = puVar12;
            if (uVar1 <= uVar9) {
              _memset(uVar1 * 4 + puVar12[2],0,(uVar9 - uVar1) * 4 + 4);
              puVar12[1] = uVar9 + 1;
              puVar11 = (uint *)param_2[4];
            }
  ...
  undefined4 *param_4;
{
  ...
  *param_4 = param_2;
  param_4[1] = param_3;
  iVar1 = ((int (*)())FUN_00140e7c)(param_1,param_2,param_3);
  if ((((iVar1 != 0) &&
...
/* FUN_0014375c @ 0x14375c (1672 bytes) */
  ...
  do {
    do {
      do {
        ...
        piVar6 = (int *)0x0;
        if (uVar8 < local_6c) {
          piVar6 = (int *)(uVar8 * 4 + local_68);
        }
        iVar11 = *piVar6;
        FUN_00194208(&local_70,uVar8);
        piVar6 = (int *)0x0;
        uVar8 = local_5c - 1;
        if (uVar8 < local_5c) {
          piVar6 = (int *)(uVar8 * 4 + local_58);
        }
        iVar15 = *piVar6;
          ...
          do {
            if (uVar13 < uVar14) {
              if (uVar14 < *puVar16) {
                ...
                puVar17 = puVar16;
                if (uVar4 <= uVar14) {
                  _memset(uVar4 * 4 + puVar16[2],0,(uVar14 - uVar4) * 4 + 4);
                  puVar16[1] = uVar8;
              ...
              if (uVar13 < *puVar17) {
                ...
                puVar16 = puVar17;
                if (uVar4 <= uVar13) {
                  _memset(uVar4 * 4 + puVar17[2],0,(uVar13 - uVar4) * 4 + 4);
                  puVar17[1] = uVar13 + 1;
                  puVar16 = *(uint **)(iVar11 + 0x10);
                }
                      ...
                      do {
                        if (*(byte *)((int)&local_78 + iVar9) != 4) {
                          *(undefined1 *)((int)&local_78 + iVar9) =
                               *(undefined1 *)
                                ((int)&STACKARG(0x20) + (uint)*(byte *)((int)&local_78 + iVar9));
                        }
                        iVar3 = local_78;
                        iVar9 = iVar9 + 1;
                        iVar7 = iVar7 + -1;
  ...
  if (iVar10 == iVar8) {
    ...
    if (0 < (int)uVar1) {
      ...
      do {
        if (uVar7 < *puVar9) {
          if (uVar1 <= uVar7) {
            _memset(uVar1 * 4 + puVar9[2],0,(uVar7 - uVar1) * 4 + 4);
            puVar9[1] = uVar7 + 1;
          }
  ...
  int *param_1;
{
  ...
  iVar7 = FUN_00193e18(uVar9,0x2c0);
  iVar2 = param_1[1];
  ...
  if (iVar6 != 0) {
    ...
    do {
      ...
      iVar21 = *(int *)(iVar2 + 0x98);
      if (iVar6 != 0) {
        do {
          iVar5 = iVar6;
          if ((*(uint *)(iVar21 + 0x14) & 1) != 0) {
            iVar6 = FUN_0011379c(*(undefined4 *)(param_1[1] + 8),iVar21);
            if (iVar6 != 0) {
              bVar1 = true;
              iVar6 = *(int *)(param_1[1] + 900);
              for (iVar5 = *(int *)(*(int *)(param_1[1] + 900) + 8); iVar5 != 0;
                  iVar5 = *(int *)(iVar5 + 8)) {
                iVar8 = *(int *)(*(int *)(iVar6 + 0x98) + 8);
                if (iVar8 != 0) {
                  iVar17 = uVar10 * 0x2c;
                  ...
                  do {
                    ...
                    if ((*(uint *)(iVar5 + 0x14) & 1) != 0) {
                      if (bVar1) {
                        ...
                        iVar8 = FUN_0011379c(*(undefined4 *)(param_1[1] + 8),iVar5);
                        if (iVar8 == 0) {
                          iVar4 = *(int *)(iVar5 + 8);
                        }
                        else {
                          ...
                          uVar13 = uVar11;
                          iVar8 = iVar7;
                          if ((uVar11 <= uVar10) && (uVar13 = uVar10 + 1, uVar3 < uVar13)) {
                            uVar3 = (uVar3 << 4) / 10;
                            if (uVar3 < uVar13) {
                              uVar3 = uVar13;
                            }
                            iVar8 = FUN_00193e18(uVar9,uVar3 * 0x2c);
                            if (uVar11 != 0) {
                              uVar19 = 0;
                              iVar4 = 0;
                              do {
                                uVar19 = uVar19 + 1;
                                _memcpy(iVar8 + iVar4,iVar7 + iVar4,0x2c);
                                iVar4 = iVar4 + 0x2c;
                              } while (uVar11 != uVar19);
                            }
                            FUN_00193cc0(uVar9,iVar7);
                          }
                          iVar4 = ((int (*)())FUN_001436b4)(param_1,iVar21,iVar5,iVar8 + iVar17);
                          uVar11 = uVar13;
                          iVar7 = iVar8;
                          if (iVar4 == 0) {
                            iVar4 = *(int *)(iVar5 + 8);
...
LAB_00146530:
    do {
      if ((int)uVar10 < 1) goto LAB_00146538;
      uVar13 = 0xffffffff;
      iVar2 = 0;
      iVar18 = 0;
      uVar19 = 0;
      ...
      do {
        uVar15 = uVar11;
        iVar7 = iVar6;
        if ((uVar11 <= uVar19) && (uVar15 = uVar19 + 1, uVar3 < uVar15)) {
          uVar3 = (uVar3 << 4) / 10;
          if (uVar3 < uVar15) {
            uVar3 = uVar15;
          }
          iVar7 = FUN_00193e18(uVar9,uVar3 * 0x2c);
          if (uVar11 != 0) {
            uVar20 = 0;
            iVar21 = 0;
            do {
              uVar20 = uVar20 + 1;
              _memcpy(iVar7 + iVar21,iVar6 + iVar21,0x2c);
              iVar21 = iVar21 + 0x2c;
            } while (uVar11 != uVar20);
          }
          FUN_00193cc0(uVar9,iVar6);
        }
        iVar6 = ((int (*)())FUN_00143e40)(param_1,iVar7 + iVar18);
        if ((uVar13 == 0xffffffff) || (iVar2 < iVar6)) {
          uVar13 = uVar19;
          iVar2 = iVar6;
        }
        uVar19 = uVar19 + 1;
        iVar18 = iVar18 + 0x2c;
      } while (((int)uVar19 < (int)uVar10) && (uVar11 = uVar15, iVar6 = iVar7, uVar19 != 0x80));
      if ((uVar13 == 0xffffffff) || (iVar2 < 0)) goto LAB_00146538;
      uVar11 = uVar15;
      if ((uVar15 <= uVar13) && (uVar11 = uVar13 + 1, uVar3 < uVar11)) {
        uVar3 = (uVar3 << 4) / 10;
        if (uVar3 < uVar11) {
          uVar3 = uVar11;
        }
        iVar6 = FUN_00193e18(uVar9,uVar3 * 0x2c);
        if (uVar15 != 0) {
          uVar19 = 0;
          iVar2 = 0;
          do {
            uVar19 = uVar19 + 1;
            _memcpy(iVar6 + iVar2,iVar7 + iVar2,0x2c);
            iVar2 = iVar2 + 0x2c;
          } while (uVar19 != uVar15);
        }
        FUN_00193cc0(uVar9,iVar7);
      ...
      ((int (*)())FUN_0014532c)(param_1,piVar12);
      ...
      if (uVar15 != 0) {
        ...
        while( true ) {
          if (uVar20 <= uVar14) {
            uVar19 = uVar14 + 1;
            if ((uint)param_1[5] < uVar19) {
              uVar20 = (uint)(param_1[5] << 4) / 10;
              param_1[5] = uVar20;
              if (uVar20 < uVar19) {
                param_1[5] = uVar19;
              }
              iVar18 = param_1[6];
              iVar2 = FUN_00193e18(*piVar22,param_1[5] * 0x2c);
              param_1[6] = iVar2;
              if (param_1[4] != 0) {
                uVar20 = 0;
                iVar2 = 0;
                do {
                  iVar5 = iVar18 + iVar2;
                  uVar20 = uVar20 + 1;
                  iVar21 = param_1[6] + iVar2;
                  iVar2 = iVar2 + 0x2c;
                  _memcpy(iVar21,iVar5,0x2c);
                } while (uVar20 < (uint)param_1[4]);
              }
              FUN_00193cc0(*piVar22,iVar18);
            }
            param_1[4] = uVar19;
          }
          iVar2 = param_1[6];
          iVar18 = uVar14 * 0x2c + iVar2;
          uVar19 = uVar16;
          if ((*(int *)(iVar18 + 0x24) != 0) && (uVar19 = uVar16 + 1, uVar16 < uVar14)) {
            if ((uint)param_1[4] <= uVar16) {
              if ((uint)param_1[5] < uVar19) {
                ...
                iVar21 = FUN_00193e18(*piVar22,param_1[5] * 0x2c);
                param_1[6] = iVar21;
                if (param_1[4] != 0) {
                  uVar20 = 0;
                  iVar21 = 0;
                  do {
                    iVar8 = iVar2 + iVar21;
                    uVar20 = uVar20 + 1;
                    iVar5 = param_1[6] + iVar21;
                    iVar21 = iVar21 + 0x2c;
                    _memcpy(iVar5,iVar8,0x2c);
                  } while (uVar20 < (uint)param_1[4]);
                }
                FUN_00193cc0(*piVar22,iVar2);
                iVar2 = param_1[6];
              }
              param_1[4] = uVar19;
            }
            _memcpy(uVar16 * 0x2c + iVar2,iVar18,0x2c);
          }
          uVar14 = uVar14 + 1;
      ...
      if (uVar19 != 0) {
        ...
        do {
          uVar20 = uVar15 + 1;
          if ((uint)param_1[4] <= uVar15) {
            if ((uint)param_1[5] < uVar20) {
              uVar16 = (uint)(param_1[5] << 4) / 10;
              param_1[5] = uVar16;
              if (uVar16 < uVar20) {
                param_1[5] = uVar20;
              }
          ...
          *(undefined4 *)(uVar15 * 0x2c + param_1[6] + 0x28) = 0;
          uVar15 = uVar20;
        } while (uVar20 < uVar19);
      }
      uVar19 = uVar11;
      ...
      if ((uVar11 <= uVar13) && (uVar19 = uVar13 + 1, uVar3 < uVar19)) {
        ...
        iVar2 = FUN_00193e18(uVar9,uVar3 * 0x2c);
        if (uVar11 != 0) {
          uVar15 = 0;
          iVar18 = 0;
          do {
            uVar15 = uVar15 + 1;
            _memcpy(iVar2 + iVar18,iVar7 + iVar18,0x2c);
            iVar18 = iVar18 + 0x2c;
          } while (uVar15 != uVar11);
        }
        FUN_00193cc0(uVar9,iVar7);
      ...
      if ((uVar19 <= uVar13) && (uVar11 = uVar13 + 1, uVar3 < uVar11)) {
        ...
        if (uVar19 != 0) {
          ...
          do {
            uVar15 = uVar15 + 1;
            _memcpy(iVar7 + iVar18,iVar2 + iVar18,0x2c);
            iVar18 = iVar18 + 0x2c;
          } while (uVar15 != uVar19);
        }
      ...
      if ((uVar11 <= uVar13) && (uVar19 = uVar13 + 1, uVar3 < uVar19)) {
        ...
        if (uVar11 != 0) {
          ...
          do {
            uVar15 = uVar15 + 1;
            _memcpy(iVar21 + iVar2,iVar21 + iVar7,0x2c);
            iVar21 = iVar21 + 0x2c;
          } while (uVar15 != uVar11);
        }
        FUN_00193cc0(uVar9,iVar7);
      ...
      if (piVar12[4] != 0) {
        ...
        if ((uVar19 <= uVar13) && (uVar11 = uVar13 + 1, uVar3 < uVar11)) {
          ...
          if (uVar19 != 0) {
            ...
            do {
              uVar15 = uVar15 + 1;
              _memcpy(iVar18 + iVar7,iVar18 + iVar2,0x2c);
              iVar18 = iVar18 + 0x2c;
            } while (uVar15 != uVar19);
          }
          FUN_00193cc0(uVar9,iVar2);
        ...
        if ((uVar11 <= uVar13) && (uVar19 = uVar13 + 1, uVar3 < uVar19)) {
          ...
          if (uVar11 != 0) {
            ...
            do {
              uVar15 = uVar15 + 1;
              _memcpy(iVar18 + iVar2,iVar18 + iVar7,0x2c);
              iVar18 = iVar18 + 0x2c;
            } while (uVar15 != uVar11);
          }
          FUN_00193cc0(uVar9,iVar7);
      ...
      uVar15 = uVar19;
      iVar21 = iVar2;
      if ((uVar19 <= uVar13) && (uVar15 = uVar13 + 1, uVar3 < uVar15)) {
        uVar3 = (uVar3 << 4) / 10;
        if (uVar3 < uVar15) {
          uVar3 = uVar15;
        }
        iVar21 = FUN_00193e18(uVar9,uVar3 * 0x2c);
        if (uVar19 != 0) {
          uVar11 = 0;
          iVar7 = 0;
          do {
            uVar11 = uVar11 + 1;
            _memcpy(iVar7 + iVar21,iVar7 + iVar2,0x2c);
            iVar7 = iVar7 + 0x2c;
          } while (uVar11 != uVar19);
        }
        FUN_00193cc0(uVar9,iVar2);
        piVar12 = (int *)(iVar21 + iVar6);
      }
      uVar13 = uVar10 - 1;
      uVar11 = uVar15;
      iVar7 = iVar21;
      if ((uVar15 <= uVar13) && (uVar11 = uVar10, uVar3 < uVar10)) {
        uVar3 = (uVar3 << 4) / 10;
        if (uVar3 < uVar10) {
          uVar3 = uVar10;
        }
        ...
        if (uVar15 != 0) {
          ...
          do {
            uVar10 = uVar10 + 1;
            _memcpy(iVar6 + iVar7,iVar6 + iVar21,0x2c);
            iVar6 = iVar6 + 0x2c;
          } while (uVar10 != uVar15);
        }
        FUN_00193cc0(uVar9,iVar21);
      }
      iVar6 = uVar13 * 0x2c;
      _memcpy(piVar12,iVar6 + iVar7,0x2c);
      if ((int)uVar13 < 1) goto LAB_00146538;
      uVar19 = 0;
      uVar15 = 1;
      do {
        uVar10 = uVar11;
        iVar2 = iVar7;
        if ((uVar11 <= uVar19) && (uVar10 = uVar15, uVar3 < uVar15)) {
          uVar3 = (uVar3 << 4) / 10;
          if (uVar3 < uVar15) {
            uVar3 = uVar15;
          }
          ...
          if (uVar11 != 0) {
            ...
            do {
              uVar20 = uVar20 + 1;
              _memcpy(iVar2 + iVar21,iVar7 + iVar21,0x2c);
              iVar21 = iVar21 + 0x2c;
            } while (uVar20 != uVar11);
          }
          FUN_00193cc0(uVar9,iVar7);
        ...
        iVar8 = uVar19 * 0x2c;
        iVar17 = iVar2 + iVar8;
        iVar5 = *(int *)(iVar2 + iVar8);
        uVar20 = uVar10;
        iVar21 = iVar2;
        if ((uVar10 <= uVar19) && (uVar20 = uVar15, uVar3 < uVar15)) {
          uVar3 = (uVar3 << 4) / 10;
          if (uVar3 < uVar15) {
            uVar3 = uVar15;
          }
          ...
          if (uVar10 != 0) {
            ...
            do {
              uVar11 = uVar11 + 1;
              _memcpy(iVar21 + iVar7,iVar2 + iVar7,0x2c);
              iVar7 = iVar7 + 0x2c;
            } while (uVar11 != uVar10);
          }
          FUN_00193cc0(uVar9,iVar2);
...
LAB_001463fc:
          ...
          uVar16 = uVar11;
          iVar2 = iVar7;
          if ((uVar11 <= uVar19) && (uVar16 = uVar19 + 1, uVar3 < uVar16)) {
            uVar3 = (uVar3 << 4) / 10;
            if (uVar3 < uVar16) {
              uVar3 = uVar16;
            }
          ...
          uVar11 = uVar16;
          iVar7 = iVar2;
          if ((uVar16 <= uVar10) && (uVar11 = uVar13, uVar3 < uVar13)) {
            uVar3 = (uVar3 << 4) / 10;
            if (uVar3 < uVar13) {
              uVar3 = uVar13;
            }
            ...
            if (uVar16 != 0) {
              ...
              do {
                uVar13 = uVar13 + 1;
                _memcpy(iVar7 + iVar21,iVar2 + iVar21,0x2c);
                iVar21 = iVar21 + 0x2c;
              } while (uVar13 != uVar16);
            }
            FUN_00193cc0(uVar9,iVar2);
          }
          _memcpy(iVar17,iVar6 + iVar7,0x2c);
        }
        else {
          if ((uVar20 <= uVar19) && (uVar11 = uVar15, uVar3 < uVar15)) {
            uVar3 = (uVar3 << 4) / 10;
            if (uVar3 < uVar15) {
              uVar3 = uVar15;
            }
            ...
            if (uVar20 != 0) {
              ...
              do {
                uVar10 = uVar10 + 1;
                _memcpy(iVar7 + iVar17,iVar21 + iVar17,0x2c);
                iVar17 = iVar17 + 0x2c;
              } while (uVar10 != uVar20);
            }
            FUN_00193cc0(uVar9,iVar21);
          ...
          iVar2 = ((int (*)())FUN_001436b4)(param_1,iVar5,iVar2,iVar17);
          uVar10 = uVar13;
          uVar20 = uVar19;
...
/* FUN_0014657c @ 0x14657c (92 bytes) */
...
int FUN_001466f4(param_1, param_2)
  undefined4 param_1;
  undefined4 param_2;
{
  int *piVar1;
...
/* FUN_0014675c @ 0x14675c (44 bytes) */
int FUN_0014675c(param_1, param_2)
  int param_1;
  int param_2;
{
  if ((*(int *)(param_1 + 0x120) == *(int *)(param_2 + 0x120)) &&
...
int FUN_00146788(param_1, param_2)
  int param_1;
  undefined4 param_2;
{
  int iVar1;
  ...
  iVar1 = FUN_0010497c(param_1,param_2);
  ...
  int param_2;
{
  ...
  iVar1 = ((int (*)())FUN_00139344)(param_1);
  if (iVar1 != 0) {
  ...
  undefined4 param_3;
{
  ...
  piVar1 = (int *)param_2[0x56];
  if (piVar1 == (int *)param_1[0x56]) {
    do {
      param_2 = (int *)param_2[1];
      iVar2 = (**(code **)(*param_2 + 0x34))(param_2);
      if (iVar2 != 0) {
        return 0;
      }
