            ...
            *(int *)(iVar12 + 0x6c) = param_2;
            ...
            while( true ) {
              if (uVar11 < *puVar15) {
                uVar4 = puVar15[1];
                if (uVar4 <= uVar11) {
                  _memset(uVar4 * 4 + puVar15[2],0,(uVar11 - uVar4) * 4 + 4);
                  puVar15[1] = uVar11 + 1;
                }
              ...
              if (0 < (int)uVar19) {
                while( true ) {
                  if (uVar7 < *puVar18) {
                    uVar2 = puVar18[1];
                    if (uVar2 <= uVar7) {
                      _memset(uVar2 * 4 + puVar18[2],0,(uVar7 - uVar2) * 4 + 4);
                      puVar18[1] = uVar7 + 1;
                    }
                    ...
                    if (-1 < (int)uVar17) {
                      ...
                      while( true ) {
                        if (uVar17 < *puVar18) {
                          uVar4 = puVar18[1];
                          if (uVar4 <= uVar17) {
                            _memset(uVar4 * 4 + puVar18[2],0,(uVar17 - uVar4) * 4 + 4);
                            puVar18[1] = uVar17 + 1;
                          }
        ...
        if (0 < (int)uVar11) {
          while( true ) {
            if (uVar19 < *puVar18) {
              uVar7 = puVar18[1];
              if (uVar7 <= uVar19) {
                _memset(uVar7 * 4 + puVar18[2],0,(uVar19 - uVar7) * 4 + 4);
                puVar18[1] = uVar19 + 1;
              }
            ...
            if (0 < (int)uVar14) {
              while( true ) {
                if (uVar22 < *puVar26) {
                  uVar24 = puVar26[1];
                  if (uVar24 <= uVar22) {
                    _memset(uVar24 * 4 + puVar26[2],0,(uVar22 - uVar24) * 4 + 4);
                    puVar26[1] = uVar22 + 1;
                  }
                  ...
                  if (-1 < (int)uVar24) {
                    ...
                    while( true ) {
                      if (uVar24 < *puVar26) {
                        uVar10 = puVar26[1];
                        if (uVar10 <= uVar24) {
                          _memset(uVar10 * 4 + puVar26[2],0,(uVar24 - uVar10) * 4 + 4);
                          puVar26[1] = uVar24 + 1;
                        }
                      ...
                      if (*(int *)(iVar19 + 0x2c) < 0) {
                        ...
                        *piVar9 = iVar18;
                        ...
                        uVar10 = puVar26[1];
                        if (uVar10 < *puVar26) {
                          _memset(uVar10 * 4 + puVar26[2],0,4);
                        ...
                        if (-1 < (int)uVar27) {
                          ...
                          while( true ) {
                            if (uVar27 < *puVar26) {
                              uVar6 = puVar26[1];
                              if (uVar6 <= uVar27) {
                                _memset(uVar6 * 4 + puVar26[2],0,(uVar27 - uVar6) * 4 + 4);
                                puVar26[1] = uVar27 + 1;
                              }
            ...
            if (local_64[4] == 0) {
              if (0 < (int)local_74) {
                ...
                do {
                  if (uVar24 < local_78) {
                    if (local_74 <= uVar24) {
                      _memset(local_74 * 4 + local_70,0,(uVar24 - local_74) * 4 + 4);
                      local_74 = uVar22;
                    }
                  ...
                  *(undefined4 *)(iVar20 + 0x58) = uVar3;
                  if (uVar24 < local_68) {
                    if (local_64[0] <= uVar24) {
                      _memset(local_64[0] * 4 + local_64[1],0,(uVar24 - local_64[0]) * 4 + 4);
                      local_64[0] = uVar22;
                    }
              ...
              if (0 < (int)uVar24) {
                do {
                  if (uVar23 < *puVar26) {
                    uVar10 = puVar26[1];
                    if (uVar10 <= uVar23) {
                      _memset(uVar10 * 4 + puVar26[2],0,(uVar23 - uVar10) * 4 + 4);
                      puVar26[1] = uVar23 + 1;
                    }
                    ...
                    if (((*(int *)(iVar15 + 0x2c) < 0) ||
                      ...
                      if ((int)local_74 < 1) {
                        ...
                        do {
                          if (uVar27 < local_78) {
                            if (local_74 <= uVar27) {
                              _memset(local_74 * 4 + local_70,0,(uVar27 - local_74) * 4 + 4);
                              local_74 = uVar27 + 1;
                            }
  ...
  int param_2;
{
  ...
  if (uVar7 != 0) {
    ...
    do {
      if (uVar11 < *puVar14) {
        if (uVar7 <= uVar11) {
          _memset(uVar7 * 4 + puVar14[2],0,(uVar11 - uVar7) * 4 + 4);
          puVar14[1] = uVar11 + 1;
        }
  ...
  if (0 < (int)uVar7) {
    while( true ) {
      if (uVar11 < *puVar14) {
        uVar8 = puVar14[1];
        if (uVar8 <= uVar11) {
          _memset(uVar8 * 4 + puVar14[2],0,(uVar11 - uVar8) * 4 + 4);
          puVar14[1] = uVar11 + 1;
        }
        piVar3 = (int *)(uVar11 * 4 + puVar14[2]);
      }
