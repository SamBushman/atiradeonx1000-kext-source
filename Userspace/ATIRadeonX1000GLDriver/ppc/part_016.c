...
LAB_000e5e9c:
  while( true ) {
    ...
    iVar4 = FUN_000e4c40(param_1,&local_68,*param_1);
    if (iVar4 == 0) {
      return 0;
    }
    iVar4 = param_1[0x20];
...
LAB_000e6ac4:
  ...
  case 9:
    ...
    iVar4 = local_68 + 0x22;
    local_68 = iVar7;
    FUN_000e5384(param_1,0x35,iVar7,8,param_1[iVar4]);
    break;
  default:
    goto switchD_000e61ac_caseD_a;
  case 0xf:
...
LAB_000e6870:
  ...
  case 0x67:
    ...
    iVar4 = local_68 + 0x22;
    local_68 = iVar7;
    FUN_000e5384(param_1,0x6f,iVar7,8,param_1[iVar4]);
    break;
  case 0x68:
    local_64[0] = 1.12104e-44;
    iVar7 = local_68 + -1;
    iVar4 = local_68 + 0x22;
    local_68 = iVar7;
    FUN_000e5384(param_1,0x70,iVar7,8,param_1[iVar4]);
    break;
  case 0x69:
    piVar16 = (int *)0x0;
    uVar6 = *(uint *)(param_1[0x10] + 4);
...
LAB_000e9874:
      ...
      while( true ) {
        if (*(uint *)(*(int *)(param_3 + 0xd4) + 4) < uVar4) {
          ((int (*)())FUN_000e8d5c)(param_3,param_1);
          return;
        }
...
{
  ((int (*)())FUN_000e977c)();
  ((int (*)())FUN_000e8e4c)(param_4,param_2);
  return;
}
...
LAB_000e9a40:
      ...
      while( true ) {
        if (*(uint *)(*(int *)(param_3 + 0xd0) + 4) < uVar4) {
          ((int (*)())FUN_000e8dd4)(param_3,param_1);
          return;
        }
