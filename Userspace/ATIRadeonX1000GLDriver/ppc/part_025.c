  ...
  int param_2;
{
  ...
  uVar1 = ((int (*)())FUN_000f3190)(*(undefined4 *)(param_2 * 0x18 + param_1 + 0x9c));
  return uVar1;
}
  ...
  undefined4 param_2;
{
  ...
  do {
    if (*pcVar1 != '\x04') {
      ...
      do {
        if (*pcVar2 == '\x04') {
          *pcVar2 = *(char *)((int)&(*(unsigned int *)((unsigned char *)ghidra_home + 4)) + iVar3);
        }
        pcVar2 = pcVar2 + 1;
        iVar4 = iVar4 + -1;
      } while (iVar4 != 0);
  ...
  uint param_2;
{
  ...
  if (uVar4 == 4) {
    ...
    iVar8 = 1;
    do {
      uVar7 = (uint)(&(*(unsigned int *)((unsigned char *)ghidra_home + 4)))[iVar8];
      iVar9 = iVar8;
      if ((uVar7 != 4) && (iVar9 = iVar8 + 1, uVar4 = uVar7, iVar9 < 4)) {
        iVar5 = 4 - iVar9;
        pbVar6 = (byte *)(&(*(unsigned int *)((unsigned char *)ghidra_home + 5)) + iVar8);
        do {
    ...
    iVar8 = 4;
    bVar2 = true;
    pbVar6 = &(*(unsigned int *)((unsigned char *)ghidra_home + 4));
    do {
      if (*pbVar6 == 4) {
        bVar1 = true;
      }
...
LAB_000f35b4:
  (*(unsigned char *)((unsigned char *)ghidra_home + 4)) = uVar3;
  *param_1 = (*(unsigned char *)((unsigned char *)ghidra_home + 4));
  return;
}
  ...
  int param_1;
{
  ...
  uVar1 = ((int (*)())FUN_000f3824)(*(undefined4 *)(param_1 + 0x9c));
  return uVar1;
}
...
int FUN_000f3b10(param_1, param_2)
  undefined4 param_1;
  undefined4 param_2;
{
  int iVar1;
...
int FUN_000f3b68(param_1, param_2)
  undefined4 param_1;
  undefined4 param_2;
{
  int iVar1;
...
int FUN_000f4a84(param_1, param_2, param_3, param_4, param_5, param_6, param_7)
  int *param_1;
  int param_2;
  int param_3;
  undefined4 param_4;
  ...
  undefined4 param_7;
{
  ...
  if (param_2 == 2) {
    ...
    iVar1 = FUN_000d9b58(iVar1,iVar2 + 0x58,param_1[0xe],param_4,param_5,param_6,param_7);
    if (-1 < iVar1) {
...
LAB_000f4ac4:
    ...
    if (param_2 == 4) {
      ...
      iVar1 = FUN_000d9b58(iVar1,iVar2 + 0x98,param_1[0x10],param_4,param_5,param_6,param_7);
      if (-1 < iVar1) {
  ...
  iVar1 = FUN_000d9b58(iVar1,iVar2 + 0x78,param_1[0xf],param_4,param_5,param_6,param_7);
  if (-1 < iVar1) {
...
int FUN_000f4c48(param_1, param_2, param_3, param_4, param_5, param_6)
  int param_1;
  int param_2;
  undefined4 param_3;
  undefined4 param_4;
...
int FUN_000f4d54(param_1, param_2, param_3, param_4, param_5, param_6, param_7)
  int param_1;
  undefined4 param_2;
  undefined4 param_3;
  undefined4 param_4;
