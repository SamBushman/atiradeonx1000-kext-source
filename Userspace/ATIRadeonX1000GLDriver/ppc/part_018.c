  ...
  int param_1;
{
  if (*(int *)(param_1 + 0x394) != 0) {
    FUN_00193cc0(*(undefined4 *)(*(int *)(param_1 + 8) + 0x374));
...
/* FUN_000ec4f0 @ 0xec4f0 (168 bytes) */
  ...
  int param_1;
{
  ...
  puVar2 = (undefined4 *)((int (*)())FUN_000ec5b8)();
  do {
    bVar9 = false;
    iVar6 = 1;
    puVar7 = puVar2;
  ...
  int param_3;
{
  ...
  if ((((iVar1 != 0) &&
     ...
     ((iVar1 = ((int (*)())FUN_000f2d18)(param_2,DAT_001aa804), iVar1 != 0 ||
...
/* FUN_000eced0 @ 0xeced0 (188 bytes) */
...
/* FUN_000ecfac @ 0xecfac (352 bytes) */
...
/* FUN_000ed124 @ 0xed124 (352 bytes) */
...
/* FUN_000ed89c @ 0xed89c (1244 bytes) */
        ...
        if ((piVar10[5] & 1U) != 0) {
          ...
          if (((iVar5 == 0) || (iVar5 = (**(code **)(*piVar10 + 0x2c))(piVar10), iVar5 == 0)) ||
            ...
            *puVar6 = uVar16;
            ...
            FUN_00104364(piVar10,&local_58,&local_54,local_50,*(undefined4 *)(param_1 + 8));
            puVar6[3] = local_54;
            puVar6[4] = local_50[0];
            piVar3 = piVar15;
            if (!bVar1) {
        ...
        do {
          ...
          while (piVar12 = piVar10, piVar15 != (int *)0x0) {
            ...
            if (iVar13 == *(int *)(iVar18 + 0x1c)) {
              ...
              FUN_001049e8(piVar15[1],uVar16,*(undefined4 *)(param_1 + 8));
              FUN_001236e4(uVar16,*(undefined4 *)(piVar15[1] + 0x84));
              piVar15 = piVar4;
            }
            else {
...
/* FUN_000ee7a0 @ 0xee7a0 (492 bytes) */
...
/* FUN_000eec50 @ 0xeec50 (1140 bytes) */
int FUN_000eec50(param_1)
  int param_1;
{
  int *piVar1;
  int iVar2;
...
LAB_000eed14:
  ...
  if ((*(int *)(param_1 + 0x348) == 0) && (*(int *)(param_1 + 0x350) == 0)) {
    ...
    *(undefined4 *)(iVar7 + 8) = 0;
    puVar8[0x28] = uVar9;
    FUN_000f79c4(dVar13,dVar13,dVar13,dVar13,puVar11,param_1,1);
...
LAB_000eee08:
  ...
  *(undefined4 *)(iVar3 + 0x10) = uVar9;
  FUN_000f79c4(0x3fe0000020000000,dVar13,dVar13,dVar13,iVar2,param_1,2);
  ...
  *(undefined4 *)(iVar5 + 0x10) = uVar10;
  FUN_000f79c4(0x3fefffffe0000000,dVar13,dVar13,dVar13,iVar3,param_1,2);
  ...
  *(undefined4 *)(iVar6 + 0x10) = uVar4;
  FUN_000f79c4(0x3fefffffe0000000,dVar13,dVar13,dVar13,iVar5,param_1,2);
...
/* FUN_000eee4c @ 0xeee4c (920 bytes) */
    ...
    if (piVar2 != (int *)0x0) {
      do {
        ...
        if ((piVar12[5] & 1U) != 0) {
          ...
          {
            FUN_001049e8(piVar12,iVar3,*(undefined4 *)(param_1 + 8));
          }
          iVar3 = piVar12[0x26];
          if (iVar3 == 0x2a) {
            ...
            if (iVar3 < *(int *)(param_1 + 0x3ec)) {
              do {
                ...
                *puVar5 = uVar9;
                ...
                FUN_001049e8(piVar8,iVar6,*(undefined4 *)(param_1 + 8));
...
LAB_000ef1c8:
            ...
            if ((piVar12[0x21] == 0) || ((iVar3 != 0x3b && (iVar3 != 0x2c)))) {
              if ((piVar12[0x20] == 0) ||
                 ((iVar3 = ((int (*)())FUN_000f3154)(piVar12), iVar3 == 0 ||
...
/* FUN_000ef498 @ 0xef498 (1084 bytes) */
  ...
  undefined4 param_2;
{
  ...
  iVar6 = *(int *)(param_1 + 8);
  piVar7 = *(int **)(iVar6 + 0x30c);
  iVar2 = (**(code **)(*piVar7 + 0x138))(piVar7,iVar6);
  iVar3 = (**(code **)(*piVar7 + 0x140))(piVar7,iVar6);
  iVar6 = (**(code **)(*piVar7 + 0x13c))(piVar7,iVar6);
  iVar6 = iVar2 + iVar3 + iVar6;
  uVar8 = *(undefined4 *)(*(int *)(param_1 + 8) + 0x374);
  uVar10 = iVar6 + 0x1fU >> 5;
  iVar2 = uVar10 * 4 + 0xc;
  puVar4 = (undefined4 *)FUN_00193e18(uVar8,iVar2);
  piVar7 = puVar4 + 1;
  *puVar4 = uVar8;
  puVar4[1] = uVar10;
  puVar4[2] = iVar6;
  ...
  *(int **)(param_1 + 0x430) = piVar7;
  ...
  uVar8 = *(undefined4 *)(*(int *)(param_1 + 8) + 0x374);
  puVar5 = (undefined4 *)FUN_00193e18(uVar8,0x8c);
  puVar5[1] = 0x20;
  iVar2 = 0x20;
  *puVar5 = uVar8;
  puVar5[2] = 0x400;
  ...
  *(int *)(param_1 + 0x450) = iVar2 + iVar3;
  uVar8 = FUN_00193e18(*(undefined4 *)(*(int *)(param_1 + 8) + 0x374),
                       *(int *)(*(int *)(*(int *)(param_1 + 8) + 0x30c) + 0x50) * 0xc);
  *(undefined4 *)(param_1 + 0x78) = uVar8;
  uVar8 = *(undefined4 *)(*(int *)(param_1 + 8) + 0x374);
  puVar4 = (undefined4 *)FUN_00193e18(uVar8,0x134);
  *puVar4 = uVar8;
  puVar4 = puVar4 + 1;
  ...
  *(undefined4 **)(param_1 + 0x3a0) = puVar4;
  ...
  uVar8 = *(undefined4 *)(*(int *)(param_1 + 8) + 0x374);
  puVar4 = (undefined4 *)FUN_00193e18(uVar8,0x130);
  *puVar4 = uVar8;
  puVar4 = puVar4 + 1;
  ...
  *(undefined4 **)(param_1 + 0x3a8) = puVar4;
  ...
  (**(code **)(*piVar7 + 0x14))(piVar7,uVar8);
  if (iVar2 == 1) {
    ((int (*)())FUN_000eec50)(param_1);
  }
  else if ((iVar2 == 2) || (iVar2 == 0)) {
    piVar7 = *(int **)(*(int *)(param_1 + 8) + 0x30c);
    (**(code **)(*piVar7 + 0xac))(piVar7,*(undefined4 *)(param_1 + 0x358),param_1);
  }
  ((int (*)())FUN_000ef204)(param_1);
  ...
  ((int (*)())FUN_000ed7e4)(param_1,"non_local_set");
  return;
}
  ...
  if (uVar1 != 0) {
    ...
    do {
      if (uVar3 < *puVar5) {
        puVar6 = puVar5;
        if (uVar1 <= uVar3) {
          _memset((void *)(uVar1 * 4 + puVar5[2]),0,(uVar3 - uVar1) * 4 + 4);
          puVar5[1] = uVar3 + 1;
...
/* FUN_000efa4c @ 0xefa4c (860 bytes) */
  ...
  int param_1;
{
  ...
  puVar2 = (undefined4 *)FUN_00193e18(uVar10,0x14);
  puVar9 = puVar2 + 1;
  *puVar2 = uVar10;
  puVar2[1] = 2;
  puVar2[2] = 0;
  ...
  *puVar3 = uVar10;
  ...
  if (uVar11 < *puVar9) {
    _memset((void *)(uVar11 * 4 + puVar2[3]),0,4);
    puVar4 = (undefined4 *)(uVar11 * 4 + puVar2[3]);
    puVar2[2] = uVar11 + 1;
  }
  else {
    puVar4 = (undefined4 *)FUN_0019423c(puVar9,uVar11);
  }
  *puVar4 = uVar10;
...
LAB_000efd60:
  ...
  if (uVar11 == 0) {
    ...
    while (iVar13 != 0) {
      puVar2 = (undefined4 *)0x0;
      if (iVar13 - 1U < (uint)puVar3[2]) {
        puVar2 = (undefined4 *)((iVar13 - 1U) * 4 + puVar3[3]);
      }
      uVar10 = *puVar2;
      FUN_00194208(puVar7,puVar3[2] - 1);
  ...
  piVar1 = (int *)0x0;
  if (uVar11 - 1 < uVar11) {
    piVar1 = (int *)((uVar11 - 1) * 4 + puVar2[3]);
  }
  iVar13 = *piVar1;
  ...
  if (uVar11 < *puVar9) {
    _memset((void *)(uVar11 * 4 + puVar2[3]),0,4);
    piVar1 = (int *)(uVar11 * 4 + puVar2[3]);
    puVar2[2] = uVar11 + 1;
  }
  else {
    piVar1 = (int *)FUN_0019423c(puVar9,uVar11);
  }
  *piVar1 = iVar13;
  iVar5 = FUN_000e79e8(iVar13);
  if (iVar5 != 0) goto code_r0x000efc2c;
  goto LAB_000efce4;
code_r0x000efc2c:
  bVar6 = true;
  iVar5 = 0;
  for (uVar11 = 1; uVar11 <= *(uint *)(*(int *)(iVar13 + 0xd0) + 4); uVar11 = uVar11 + 1) {
    iVar8 = *(int *)(iVar5 + *(int *)(*(int *)(iVar13 + 0xd0) + 8));
    if ((iVar8 != 0) && (*(int *)(iVar8 + 0x118) == 0)) {
      uVar12 = puVar2[2];
      if (uVar12 < *puVar9) {
        _memset((void *)(uVar12 * 4 + puVar2[3]),0,4);
        piVar1 = (int *)(uVar12 * 4 + puVar2[3]);
        puVar2[2] = uVar12 + 1;
      }
      else {
        piVar1 = (int *)FUN_0019423c(puVar9,uVar12);
      }
      *piVar1 = iVar8;
      bVar6 = false;
...
LAB_000efce4:
    ...
    if (uVar11 - 1 < uVar11) {
      puVar4 = (undefined4 *)((uVar11 - 1) * 4 + puVar2[3]);
    }
    uVar10 = *puVar4;
    FUN_00194208(puVar9,uVar11 - 1);
    uVar11 = puVar3[2];
    if (uVar11 < *puVar7) {
      ...
      puVar4 = (undefined4 *)(uVar11 * 4 + puVar3[3]);
      puVar3[2] = uVar11 + 1;
    }
    else {
      puVar4 = (undefined4 *)FUN_0019423c(puVar7,uVar11);
    }
    *puVar4 = uVar10;
  }
  goto LAB_000efd60;
...
/* FUN_000efde4 @ 0xefde4 (888 bytes) */
int FUN_000efde4(param_1)
  int param_1;
{
  int *piVar1;
  undefined4 *puVar2;
...
/* FUN_000f019c @ 0xf019c (792 bytes) */
  ...
  if (((*(uint *)(param_1 + 0x30) & 0x4000) != 0) && ((*(uint *)(param_1 + 0x30) & 0x80000) == 0)) {
    ...
    if (uVar3 == 0) {
      ...
      do {
        if (uVar2 < *puVar9) {
          puVar10 = puVar9;
          if (uVar3 <= uVar2) {
            _memset((void *)(uVar3 * 4 + puVar9[2]),0,(uVar2 - uVar3) * 4 + 4);
            puVar9[1] = uVar2 + 1;
    ...
    *puVar4 = uVar12;
    ...
    if (*(int *)(param_1 + 0x3f8) < (int)uVar3) {
      ...
      FUN_00106004(iVar8,2,piVar11,0,*(undefined4 *)(param_1 + 8));
      return;
    }
  }
  return;
  ...
  if ((iVar4 == 0) && (iVar4 = (**(code **)(*param_2 + 100))(param_2), iVar4 != 0)) {
    for (iVar4 = 1; iVar5 = (**(code **)(*param_2 + 0x14))(param_2), iVar4 <= iVar5;
      ...
      if ((((param_2[iVar4 * 6 + 0x28] & 1U) != 0) || ((param_2[iVar4 * 6 + 0x28] & 2U) != 0)) ||
         (iVar5 = ((int (*)())FUN_000f31e8)(param_2,iVar4), iVar5 == 0)) goto LAB_000f0628;
    }
...
LAB_000f0628:
  ...
  if (bVar2) {
    ...
    if (iVar5 != 0) {
      ...
      FUN_000f79c4(dVar10,dVar10,dVar10,dVar10,param_2,
                   *(undefined4 *)(*(int *)(param_1 + 8) + 0x6c4),1);
      uVar3 = DAT_001aa804;
      param_2[0x49] = iVar4;
...
/* FUN_000f07a8 @ 0xf07a8 (3348 bytes) */
...
LAB_000f1384:
        do {
          while( true ) {
            ...
            if (local_84 != DAT_001aa808) break;
          ...
          if (iVar15 != 0) {
            ...
            iVar15 = local_80;
            if (iVar9 == 0) {
              if (((piVar8[5] & 0x200U) != 0) && (local_80 != DAT_001aa808)) {
                uVar2 = puVar5[2];
                if (uVar2 < *puVar12) {
                  _memset((void *)(uVar2 * 4 + puVar5[3]),0,4);
                  puVar5[2] = uVar2 + 1;
              ...
              if (iVar15 != 0) {
                for (iVar15 = 1; iVar9 = (**(code **)(*piVar8 + 0x14))(piVar8), iVar15 <= iVar9;
                  ...
                  if ((((piVar8[iVar15 * 6 + 0x28] & 1U) != 0) ||
                     ...
                     (iVar9 = ((int (*)())FUN_000f31e8)(piVar8,iVar15), iVar9 == 0)) goto LAB_000f101c;
                }
                if ((piVar8[0x48] == 0) && (piVar8[0x49] == 0)) {
                  if (((piVar8[0x20] != 0) &&
                    ...
                    piVar14 = piVar8;
                    do {
                      if (*(byte *)(piVar14 + 0x27) - 2 < 2) goto LAB_000f101c;
...
LAB_000f101c:
              ...
              iVar15 = ((int (*)())FUN_000f2d18)(local_84,uVar16);
              if ((iVar15 == 0) &&
              ...
              if (iVar15 != 0) {
                for (iVar15 = 1; iVar9 = (**(code **)(*piVar8 + 0x14))(piVar8), iVar15 <= iVar9;
                  ...
                  if ((((piVar8[iVar15 * 6 + 0x28] & 1U) != 0) ||
                      ((piVar8[iVar15 * 6 + 0x28] & 2U) != 0)) ||
                     (iVar9 = ((int (*)())FUN_000f31e8)(piVar8,iVar15), iVar9 == 0)) goto LAB_000f1384;
                }
                if ((piVar8[0x48] == 0) && (piVar8[0x49] == 0)) {
                  if (((piVar8[0x20] != 0) &&
                      ((iVar15 = FUN_00126760(piVar8[0x26]), iVar15 != 0 && ((piVar8[5] & 2U) == 0))
                    ...
                    piVar14 = piVar8;
                    do {
                      if (*(byte *)(piVar14 + 0x27) - 2 < 2) goto LAB_000f1384;
                      piVar14 = (int *)((int)piVar14 + 1);
                      iVar15 = iVar15 + -1;
                    } while (iVar15 != 0);
                  }
...
/* FUN_000f14f8 @ 0xf14f8 (2148 bytes) */
  ...
  if (iVar4 == 0) {
    ...
    if (param_3 == (int *)0x0) {
      ...
      if (((iVar6 == 0) && (iVar6 = (**(code **)(*piVar5 + 0x7c))(piVar5), iVar6 == 0)) &&
        ...
        ((int (*)())FUN_000f302c)(&local_44,uVar14,*(undefined4 *)(iVar4 + 0x10));
        uVar2 = piVar5[5];
        iVar4 = local_44;
        do {
          if ((uVar2 & 0x200) == 0) {
LAB_000f17dc:
          ...
          ((int (*)())FUN_000f302c)(&local_40,iVar4,*(undefined4 *)(iVar12 + 0x10));
          uVar2 = piVar7[5];
          piVar5 = piVar7;
          iVar4 = local_40;
        } while( true );
      ...
      *(undefined4 *)(*(int *)(param_1 + 0x340) + 300) = 1;
      ...
      if ((((piVar5[0x56] == piVar7[0x56]) &&
        ...
        if (((((int)(piVar5[0x58] - uVar2) < 0) || (piVar5[0x58] == uVar2)) &&
          ...
          FUN_000e76c4(iVar6,*(undefined4 *)(param_1 + 0x340));
          iVar4 = FUN_001054ec(piVar5,0);
          ((int (*)())FUN_000f302c)(&local_3c,uVar13,*(undefined4 *)(iVar4 + 0x10));
          do {
            (**(code **)(*piVar5 + 0x94))
                      (piVar5,*(undefined4 *)(param_1 + 0x340),*(undefined4 *)(param_1 + 8));
            ...
            while ((uVar2 & 0x200) != 0) {
              ...
              ((int (*)())FUN_000f302c)(local_38,iVar4,*(undefined4 *)(iVar9 + 0x10));
              iVar4 = local_38[0];
              piVar5 = piVar8;
              uVar2 = piVar8[5];
            }
            ...
            uVar14 = 7;
            ((int (*)())FUN_000f302c)(&local_48,uVar11,*(undefined4 *)(iVar4 + 0x10));
            bVar1 = iVar12 == 1;
            iVar12 = iVar12 + 1;
            local_3c = local_48;
            piVar5 = piVar7;
...
LAB_000f1940:
    ...
    (*UNRECOVERED_JUMPTABLE)(param_3,uVar14,uVar11);
    return;
  }
  return;
}

/* FUN_000f1d7c @ 0xf1d7c (3108 bytes) */
  ...
  int *param_3;
{
  ...
  *(int *)(param_1 + 0x474) = *(int *)(param_1 + 0x474) + 1;
  ...
  if (local_54 < local_58) {
    iVar4 = local_54 * 4;
    _memset((void *)(iVar4 + local_50),0,4);
    local_54 = uVar8 + 1;
      ...
      if (uVar8 == 0) {
        ...
        while (local_74 != 0) {
          ...
          if (local_74 - 1 < local_74) {
            puVar2 = (undefined4 *)((local_74 - 1) * 4 + local_70);
          }
          piVar12 = (int *)*puVar2;
          FUN_00194208(&local_78);
          piVar3 = (int *)0x0;
          if (local_64 - 1 < local_64) {
            piVar3 = (int *)((local_64 - 1) * 4 + local_60);
          }
          iVar4 = *piVar3;
        ...
        FUN_000f31f8(local_38,DAT_001aa800);
      ...
      if (iVar4 == 0) {
        ...
        if (iVar4 != 0) {
          ...
          if (local_74 < local_78) {
            iVar4 = local_74 * 4;
            _memset((void *)(iVar4 + local_70),0,4);
            local_74 = uVar9 + 1;
          ...
          *puVar2 = piVar3;
          if (local_64 < local_68) {
            iVar4 = local_64 * 4;
            _memset((void *)(iVar4 + local_60),0,4);
            local_64 = uVar9 + 1;
              ...
              if (0 < piVar3[0x21]) {
                ...
                do {
                  ...
                  if ((uVar8 & *(uint *)(iVar5 + 0xc)) != 0) {
                    if (local_74 < local_78) {
                      iVar5 = local_74 * 4;
                      _memset((void *)(iVar5 + local_70),0,4);
                      local_74 = uVar9 + 1;
  ...
  int param_1;
{
  ...
  iVar1 = (**(code **)(**(int **)(*(int *)(param_1 + 8) + 0x30c) + 0xd8))();
  if (iVar1 == 0) {
    ((int (*)())FUN_000eced0)(param_1);
    piVar8 = *(int **)(*(int *)(param_1 + 0x3a8) + 0x98);
