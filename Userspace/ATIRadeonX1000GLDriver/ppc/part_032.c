  ...
  *puVar3 = uVar9;
  ...
  if (uVar6 != 0) {
    do {
      if (uVar10 < *param_2) {
        if (uVar6 <= uVar10) {
          _memset(uVar6 * 4 + param_2[2],0,(uVar10 - uVar6) * 4 + 4);
          param_2[1] = uVar10 + 1;
        }
  ...
  uint *param_3;
{
  ...
  if (uVar2 != 0) {
    ...
    do {
      if (uVar7 < *param_3) {
        if (uVar2 <= uVar7) {
          _memset(uVar2 * 4 + param_3[2],0,(uVar7 - uVar2) * 4 + 4);
          param_3[1] = uVar7 + 1;
        }
        ...
        do {
          ...
          if (uVar2 != 0) {
            ...
            do {
              if (uVar10 < *puVar11) {
                if (uVar2 <= uVar10) {
                  _memset(uVar2 * 4 + puVar11[2],0,(uVar10 - uVar2) * 4 + 4);
                  puVar11[1] = uVar10 + 1;
                }
  ...
  uint *param_5;
{
  ...
  if (uVar2 != 0) {
    ...
    do {
      if (uVar6 < *param_5) {
        if (uVar2 <= uVar6) {
          _memset(uVar2 * 4 + param_5[2],0,(uVar6 - uVar2) * 4 + 4);
          param_5[1] = uVar6 + 1;
        }
  ...
  *param_2 = iVar6 + 4;
  ...
  if (0 < (int)uVar1) {
    ...
    do {
      if (uVar7 < *param_1) {
        if (uVar1 <= uVar7) {
          _memset(uVar1 * 4 + param_1[2],0,(uVar7 - uVar1) * 4 + 4);
          param_1[1] = uVar7 + 1;
        }
  ...
  int param_4;
{
  ...
  if (0 < (int)uVar2) {
    ...
    do {
      if (uVar8 < *param_2) {
        if (uVar2 <= uVar8) {
          _memset(uVar2 * 4 + param_2[2],0,(uVar8 - uVar2) * 4 + 4);
          param_2[1] = uVar8 + 1;
        }
  ...
  int param_4;
{
  ...
  if (0 < (int)uVar5) {
    ...
    do {
      if (uVar10 < *param_2) {
        if (uVar5 <= uVar10) {
          _memset(uVar5 * 4 + param_2[2],0,(uVar10 - uVar5) * 4 + 4);
          param_2[1] = uVar10 + 1;
        }
  ...
  uint *param_2;
{
  ...
  if (uVar2 != 0) {
    ...
    do {
      if (uVar6 < *param_2) {
        if (uVar2 <= uVar6) {
          _memset(uVar2 * 4 + param_2[2],0,(uVar6 - uVar2) * 4 + 4);
          param_2[1] = uVar6 + 1;
        }
  ...
  if (iVar1 == 0) {
    ...
    if (uVar13 != 0) {
      ...
      do {
        ...
        if (uVar5 < uVar9) {
          if (uVar13 <= uVar5) {
            _memset(uVar13 * 4 + puVar16[2],0,(uVar5 - uVar13) * 4 + 4);
            uVar9 = *puVar16;
            puVar16[1] = uVar12;
          }
          ...
          if (iVar6 == 0) {
            ...
            if (uVar13 != 0) {
              ...
              do {
                if (uVar12 < *puVar16) {
                  if (uVar13 <= uVar12) {
                    _memset(uVar13 * 4 + puVar16[2],0,(uVar12 - uVar13) * 4 + 4);
                    puVar16[1] = uVar12 + 1;
                  }
...
LAB_00112ec4:
  ...
  if (uVar12 < *puVar16) {
    if (uVar5 <= uVar12) {
      _memset(uVar5 * 4 + puVar16[2],0,(uVar12 - uVar5) * 4 + 4);
      puVar16[1] = uVar12 + 1;
    }
...
code_r0x00112df4:
  if (uVar9 < *puVar16) {
    if (uVar5 <= uVar9) {
      _memset(uVar5 * 4 + puVar16[2],0,(uVar9 - uVar5) * 4 + 4);
      puVar16[1] = uVar12 + 2;
    }
  ...
  int param_2;
{
  ...
  iVar1 = (**(code **)(**(int **)(param_2 + 0x30c) + 0x16c))(*(int **)(param_2 + 0x30c),param_2);
  ...
  int param_1;
{
  ...
  iVar2 = (**(code **)(**(int **)(param_1 + 0x30c) + 0x16c))(*(int **)(param_1 + 0x30c));
  iVar3 = (**(code **)(**(int **)(param_1 + 0x30c) + 0x40))(*(int **)(param_1 + 0x30c));
  if (iVar3 < 1) {
LAB_00113034:
    uVar4 = 1;
  }
  ...
  int param_2;
{
  ...
  iVar1 = (**(code **)(**(int **)(param_1 + 0x30c) + 0x16c))(*(int **)(param_1 + 0x30c),param_2);
  ...
  undefined4 param_7;
{
  ...
  uVar1 = 0;
  a0 = *(int **)(param_1 + 0x30c);
  if ((a0[2] & 0x10U) != 0) {
    iVar2 = (**(code **)(*a0 + 0x16c))(a0);
