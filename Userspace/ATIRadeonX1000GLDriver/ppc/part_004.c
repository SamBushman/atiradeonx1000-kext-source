...
void FUN_000243f0(int param_1,undefined4 param_2,int param_3,undefined4 param_4,undefined4 param_5,
...
void FUN_00024470(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_000244f0(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_00024570(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_000245f0(int param_1,undefined4 *param_2,undefined4 param_3,undefined4 param_4,
...
void FUN_00024670(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_000246f0(int param_1,undefined4 *param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5,undefined4 param_6,double fparam_1,double fparam_2,
                 double fparam_3,double fparam_4,double fparam_5,double fparam_6,double fparam_7,
                 double fparam_8,double fparam_9)
...
void FUN_00024770(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_000247f0(int param_1,undefined4 *param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5,undefined4 param_6,double fparam_1,double fparam_2,
                 double fparam_3,double fparam_4,double fparam_5,double fparam_6,double fparam_7,
                 double fparam_8,double fparam_9)
...
void FUN_00024870(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_000248f0(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_00024970(int param_1,int param_2,int param_3,int param_4,undefined4 param_5,
...
LAB_0002515c:
  ...
  case 0xf:
    iVar23 = *(int *)(param_1 + 0x10);
    local_90 = (float)*(double *)(FUN_00001830 + iVar23);
    local_8c = (float)*(double *)(iVar23 + 0x1838);
    local_84[0] = 1.0;
    local_88 = (float)(*(double *)(iVar23 + 0x1838) - *(double *)(FUN_00001830 + iVar23));
    goto LAB_00025ac8;
  case 0x12:
...
LAB_00025f80:
  ...
  piVar16 = piVar5 + 5;
  if (iVar10 == 0) {
    FUN_000a0570(piVar17,1,piVar16);
    iVar10 = piVar5[5];
    if (iVar10 != 0) goto LAB_00025fac;
LAB_000263d8:
    uVar9 = 0;
  }
  else {
LAB_00025fac:
    FUN_000a0380(piVar17,0x8804,iVar10);
    if (piVar5[3] == param_2[5]) {
      pbVar15 = (byte *)param_2[0xe];
      if (pbVar15 != (byte *)0x0) {
...
LAB_00026008:
          ...
          if ((uint)pbVar15[1] == *(uint *)(in_r8 + (uint)*pbVar15 * 0x10)) {
            do {
              uVar4 = uVar4 - 1;
        ...
        if (((((uVar13 & 0x1000000) != 0) &&
             ((uVar13 >> 0x17 & 1) != (uint)(byte)((unsigned char *)0x00002b7c)[param_1])) ||
            (((uVar13 & 0x400000) == 0 &&
             ((uVar13 >> 0x12 & 0xf) != (*(uint *)(param_1 + 0x1ae4) >> 6 & 0xffff))))) || (bVar12))
        {
          uVar4 = param_2[0xf];
          param_2[0xf] = uVar4 | 1;
      ...
      *(undefined1 *)(param_2 + 10) = 0;
      ...
      while( true ) {
        ...
        *(uint *)(piVar6[0xd] + 0x20) =
        ...
        iVar11 = piVar6[0xd];
        *(uint *)(iVar11 + 0x20) =
             (*(uint *)(param_1 + 0x1ae4) & 0x3c0) << 0xc | *(uint *)(iVar11 + 0x20) & 0xffc3ffff;
        iVar10 = FUN_00048da0(piVar6);
        if (iVar10 == 0) {
          *piVar17 = 0;
          FUN_0008e2e0(piVar17,0,piVar6[0xb],piVar6[10]);
          bVar12 = *piVar17 == 0;
          bVar3 = !bVar12;
          if (!bVar3) {
            iVar10 = piVar6[0xd];
      ...
      if (bVar3) {
        if (*(short *)*param_2 == -0x74d0) {
          ...
          *piVar17 = 0;
          ...
          if (pcVar7 == (char *)0x0) {
            FUN_000a0d70(piVar17,1,piVar16);
            *piVar16 = 0;
            return 0;
          }
          sVar8 = _strlen(pcVar7);
          FUN_000a0300(piVar17,0x8804,0x8875,sVar8,pcVar7,in_r8,iVar11,iVar14);
          _free(pcVar7);
          bVar3 = *piVar17 != 0;
        }
      }
...
LAB_00026ea8:
        ...
        *(undefined4 *)(FUN_000026c8 + param_1 + 4) = uVar10;
...
LAB_00026d64:
  ...
  *puVar6 = 0x82c;
  ...
  puVar6[4] = ((unsigned char *)0x00001393);
  puVar6[2] = 0xc0003400;
  puVar6[5] = 0;
  puVar6[1] = uVar10;
  ...
  *(undefined4 **)(param_1 + 0x1dc) = puVar8;
  if (((*(uint *)(param_1 + 0x27d8) & 2) != 0) && ((*(uint *)(param_1 + 0x24) & 2) != 0)) {
    FUN_0000b620(param_1,iVar12,iVar7,param_4,in_r7,uVar11,0xc0003400,puVar8);
  }
LAB_00026f60:
  *(undefined1 *)(param_1 + 0x2a5e) = 1;
  return;
...
void FUN_00026f80(int param_1,uint *param_2,uint *param_3,undefined4 param_4,undefined4 param_5,
...
uint FUN_000273a0(int param_1,uint *param_2,uint *param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,undefined4 param_7,double fparam_1,double fparam_2,
                 double fparam_3,double fparam_4,double fparam_5,double fparam_6,double fparam_7,
                 double fparam_8,double fparam_9)
...
LAB_000284b0:
  ...
  if (((((*(int *)in_stack_0000003c[1] != 0) &&
        (iVar24 = FUN_0001e280(param_1,in_stack_0000003c,1), iVar24 == 0)) ||
       ((puVar20 = PTR_DAT_001e88c8, (int *)in_stack_0000003c[2] == (int *)0x0 ||
        ((iVar24 = *(int *)in_stack_0000003c[2], iVar24 == 0 ||
         (uVar27 = *(uint *)*in_stack_0000003c, uVar38 != uVar27)))))) ||
  ...
  *puVar26 = 0x40000000;
  ...
  puVar26[2] = *puVar32;
  puVar26[3] = uVar38 - *(int *)*in_stack_0000003c;
  ...
  puVar26[199] = ((unsigned char *)0x00001087);
  ...
  *(undefined4 **)(param_1 + 0x1d8) = puVar32;
  ...
  puVar26[0xcf] = 0;
  puVar26[0xd1] = 10;
  puVar26[0xd0] = ((unsigned char *)0x00001393);
  puVar26[0xd2] = ((unsigned char *)0x000013c6);
  puVar26[0xd3] = 3;
  puVar26[0xd4] = 0x5c8;
  puVar26[0xd5] = 0x20000;
  puVar26[0xd6] = (*(unsigned char *)0x000010ea);
  uVar34 = *(undefined4 *)(param_1 + 0x1cfc);
  puVar26[0xd8] = ((unsigned char *)0x000010fa);
  puVar26[0xd7] = uVar34;
  ...
  puVar26[0x18b] = 0x82c;
  puVar26[0xea] = uVar34;
  uVar34 = *(undefined4 *)(FUN_00001dc4 + param_1);
  puVar26[0xeb] = ((unsigned char *)0x000010ae);
  puVar26[0x18c] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x1d70);
  puVar26[0xed] = ((unsigned char *)0x00001394);
  puVar26[0xec] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x1d30);
  puVar26[0xef] = ((unsigned char *)0x00001380);
  puVar26[0xf1] = ((unsigned char *)0x00001002);
  puVar26[0xf0] = 0;
  puVar26[0xee] = uVar34;
  ...
  puVar26[0xf7] = 0x82d;
  puVar26[0xf6] = uVar34;
  uVar34 = *(undefined4 *)(FUN_000026c8 + param_1 + 4);
  puVar26[0xf9] = 0x854;
  puVar26[0xf8] = uVar34;
  ...
  puVar26[0xfd] = ((unsigned char *)0x000013c0);
  puVar26[0xfc] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x1ce0);
  puVar26[0xff] = ((unsigned char *)0x000012f0);
  ...
  puVar26[0x101] = ((unsigned char *)0x000012f5);
  uVar33 = *(uint *)(param_1 + 0x1c8c);
  puVar26[0x102] = uVar33;
  if ((*(uint *)(puVar20 + (uint)(byte)((unsigned char *)0x00002b7f)[param_1] * 0x24 + 0x18) & 0x8000) == 0) {
    puVar26[0x102] = uVar33 & 0xfffff7ff;
  }
  puVar26[0x103] = ((unsigned char *)0x000010a2);
  uVar34 = *(undefined4 *)(param_1 + 0x1d7c);
  puVar26[0x105] = ((unsigned char *)0x00001381);
  ...
  puVar26[0x107] = ((unsigned char *)0x0000109e);
  uVar35 = 0xc0221000;
  uVar31 = 0xaaaa;
  uVar30 = 0x110f8;
  iVar39 = 0;
  ...
  puVar26[0x109] = ((unsigned char *)0x00001096);
  puVar26[0x108] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x1df8);
  puVar26[0x10b] = ((unsigned char *)0x00001041);
  puVar26[0x108] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x29f0);
  puVar26[0x10d] = ((unsigned char *)0x00001046);
  puVar26[0x10c] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x1dfc);
  puVar26[0x10f] = ((unsigned char *)0x00001094);
  puVar26[0x127] = ((unsigned char *)0x00001095);
  puVar26[0x111] = ((unsigned char *)0x00001095);
  puVar26[0x14d] = ((unsigned char *)0x00001180);
  puVar26[0x113] = ((unsigned char *)0x00001095);
  puVar26[0x115] = ((unsigned char *)0x00001095);
  puVar26[0x117] = ((unsigned char *)0x00001095);
  puVar26[0x10e] = uVar34;
  puVar26[0x119] = ((unsigned char *)0x00001095);
  puVar26[0x11b] = ((unsigned char *)0x00001095);
  puVar26[0x11d] = ((unsigned char *)0x00001095);
  puVar26[0x11f] = ((unsigned char *)0x00001095);
  puVar26[0x121] = ((unsigned char *)0x00001095);
  puVar26[0x123] = ((unsigned char *)0x00001095);
  puVar26[0x125] = ((unsigned char *)0x00001095);
  puVar26[0x129] = 0xc0221000;
  puVar26[0x110] = 0;
  puVar26[0x14e] = 2;
  puVar26[0x14f] = ((unsigned char *)0x00001189);
  puVar26[0x151] = ((unsigned char *)0x00001181);
  puVar26[0x153] = ((unsigned char *)0x0000118d);
  puVar26[0x155] = ((unsigned char *)0x0000118e);
  puVar26[0x157] = ((unsigned char *)0x0000118c);
  puVar26[0x159] = ((unsigned char *)0x000011a9);
  uVar34 = *(undefined4 *)(param_1 + 0x257c);
  puVar26[0x15b] = ((unsigned char *)0x000011aa);
  puVar26[0x15a] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x2580);
  puVar26[0x15d] = ((unsigned char *)0x000011ab);
  puVar26[0x15c] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x2584);
  puVar26[0x15f] = ((unsigned char *)0x000011ac);
  puVar26[0x15e] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x2588);
  puVar26[0x161] = ((unsigned char *)0x000010c0);
  puVar26[0x160] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x216c);
  puVar26[0x163] = ((unsigned char *)0x000010c1);
  puVar26[0x165] = ((unsigned char *)0x000010c8);
  puVar26[0x167] = ((unsigned char *)0x0000101d);
  puVar26[0x162] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x2128);
  puVar26[0x169] = ((unsigned char *)0x0000138a);
  puVar26[0x16b] = ((unsigned char *)0x0000138e);
  puVar26[0x170] = 0;
  puVar26[0x16d] = ((unsigned char *)0x00001040);
  puVar26[0x16a] = 0;
  puVar26[0x16c] = 0;
  puVar26[0x16e] = 0;
  puVar26[0x168] = uVar34;
  puVar26[0x16f] = (*(unsigned char *)0x00001150);
  puVar26[0x171] = ((unsigned char *)0x00001100);
  uVar34 = *(undefined4 *)(param_1 + 0x1f1c);
  puVar26[0x173] = ((unsigned char *)0x00001110);
  ...
  puVar26[0x177] = ((unsigned char *)0x00001130);
  puVar26[0x176] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x1fdc);
  puVar26[0x179] = ((unsigned char *)0x00001140);
  puVar26[0x178] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x201c);
  puVar26[0x17b] = ((unsigned char *)0x000010f4);
  puVar26[0x17c] = 0xaaaa;
  puVar26[0x17d] = ((unsigned char *)0x00001383);
  puVar26[0x17a] = uVar34;
  uVar34 = *(undefined4 *)(param_1 + 0x1d34);
  puVar26[0x17f] = ((unsigned char *)0x00001386);
  ...
  puVar26[0x184] = ((unsigned char *)0x00001087);
    ...
    if (bVar1) {
      *(undefined4 **)(param_1 + 0x298c) = puVar26;
      ...
      if (*(int *)*in_stack_0000003c != 0) {
        FUN_0000b670(param_1,*(int *)*in_stack_0000003c,uVar37 * local_108,puVar26,uVar30,uVar31,
                     in_stack_0000003c,uVar35);
        return 1;
      }
      return 1;
    }
  ...
  int param_8;
{
  ...
  iVar6 = FUN_0000a2f0((uint)*(ushort *)(((unsigned char *)0x00002db8) + iVar17),*(undefined4 *)(param_1 + 0x154));
  if (((((*(uint *)(((unsigned char *)0x000030b0) + iVar17) & 0x1ff) == 0) &&
       ((*(uint *)(((unsigned char *)0x000030b4) + iVar17) & 0xff0000) == 0)) || (param_6 - 0x1901U < 2)) ||
     (in_stack_0000003b == '\x02')) {
    iVar5 = 0;
    bVar4 = false;
  }
  else if ((*(uint *)(((unsigned char *)0x000030b0) + iVar17) & 2) == 0) {
    if (((*(uint *)(((unsigned char *)0x000030b0) + iVar17) & 4) == 0) ||
       (*(short *)(((unsigned char *)0x00002fe8) + iVar17) != -0x7fea)) goto LAB_000293b0;
    bVar4 = true;
    iVar5 = *(int *)(((unsigned char *)0x00002ff0) + iVar17) + -1;
  }
  else if (*(short *)(((unsigned char *)0x00002fa8) + iVar17) == -0x7fea) {
    bVar4 = true;
    iVar5 = *(int *)(((unsigned char *)0x00002fb0) + iVar17) + -1;
  }
  else {
LAB_000293b0:
    iVar5 = 0;
  ...
  if (in_stack_0000003c == 0) {
    ...
    piVar20 = &iStack_e4;
    iVar18 = param_5;
    FUN_0000a6e0(param_1,param_6,param_7,param_4 - iVar5,param_5,puVar12,piVar20,aiStack_e0);
    uStack_ac = param_8 + aiStack_e0[0];
    if (param_3 < 0) {
      param_5 = param_5 + param_3;
      iVar5 = param_3 * uStack_e8;
      param_3 = 0;
      uStack_ac = uStack_ac - iVar5;
    }
    if (param_2 < 0) {
    ...
    if ((0 < param_4) && (0 < param_5)) {
      if (bVar1) {
        ...
        puVar13 = ((unsigned char *)0x00002e48) + iVar17;
        puStack_94 = ((unsigned char *)0x0007efff);
        if (((unsigned char *)0x00002e68)[iVar17] != '\0') {
          uStack_98 = uStack_98 | 2;
        }
        if (((unsigned char *)0x00002e69)[iVar17] != '\0') {
      ...
      if (piVar19 == (int *)0x0) {
        ...
        iStack_cc = param_5;
        if (param_6 == 0x1901) {
          uVar15 = *(uint *)(param_1 + 0x154);
          if ((uVar15 & 0x30000) == 0x30000) {
            if (*(int *)(param_1 + 0x1e4) + 0x28U < *(uint *)(param_1 + 0x1dc)) {
              FUN_0001a0f0(param_1,0x1000000);
              uVar15 = *(uint *)(param_1 + 0x154);
            }
...
LAB_00029878:
              if (iVar6 == 7) {
                ...
                if (iVar6 != 8) goto LAB_000298a4;
                iStack_c8 = 0xb;
              }
            }
LAB_000299f8:
            if ((bVar4) ||
               ((((bVar1 && (((*(uint *)(((unsigned char *)0x000030b4) + iVar17) & 0xff1) != 0 ||
                             ((*(uint *)((*(unsigned char *)0x00002e68) + iVar17) & 0xffff0000) != 0)))) ||
                 (param_6 - 0x1901U < 2)) ||
                ((((uStack_a8 & 0x3f) != 0 || (0x1fff < (int)uStack_a8)) ||
                 ((uStack_ac & 0x1f) != 0)))))) {
LAB_00029a74:
              uStack_c0 = uStack_b8;
              uVar15 = param_5 * uStack_b8 + 0xfff & 0xfffff000;
              if (*(uint *)(((unsigned char *)0x00002b78) + param_1) < uVar15) {
                if (*(int *)(((unsigned char *)0x00002b74) + param_1) != 0) {
                  _vfree();
                }
                pvVar8 = _valloc(uVar15);
                *(uint *)(((unsigned char *)0x00002b78) + param_1) = uVar15;
                *(void **)(((unsigned char *)0x00002b74) + param_1) = pvVar8;
              }
              ...
              else if ((((uVar15 & 0xf) != 3) || (param_6 != 0x80e1)) || (param_7 != 0x8366))
              goto LAB_00029a74;
              bVar1 = true;
              uStack_c0 = uStack_a8;
              uStack_c4 = uStack_ac;
            ...
            if (bVar4) {
              ...
              iVar6 = *(int *)(*(int *)(iVar14 + 0x140) + 0x30);
              uStack_80 = (uint)*(ushort *)(iVar6 + 0x98);
              uStack_7c = (uint)*(ushort *)(iVar6 + 0x9a);
              uStack_78 = (uint)*(ushort *)(iVar6 + 0x8c);
              uStack_74 = *(undefined4 *)(iVar6 + 0x9c);
              iVar6 = *(int *)(*(int *)(iVar14 + 0x148) + 0x30);
              uStack_70 = (uint)*(ushort *)(iVar6 + 0x98);
              uStack_6c = (uint)*(ushort *)(iVar6 + 0x9a);
              uStack_68 = (uint)*(ushort *)(iVar6 + 0x8c);
              uStack_64 = *(undefined4 *)(iVar6 + 0x9c);
              iVar6 = *(int *)(*(int *)(iVar14 + 0x144) + 0x30);
              uStack_60 = (uint)*(ushort *)(iVar6 + 0x98);
              uStack_5c = (uint)*(ushort *)(iVar6 + 0x9a);
              uStack_58 = (uint)*(ushort *)(iVar6 + 0x8c);
              uStack_54 = *(undefined4 *)(iVar6 + 0x9c);
            }
            iVar6 = _io_connect_method_structureI_structureO
                              (*(undefined4 *)(param_1 + 4),7,aiStack_e0 + 2,0x1c,0,aiStack_e0 + 1);
            if (iVar6 != 0) goto LAB_00029bd0;
            if (!bVar1) {
          ...
          if (param_6 != 0x1902) {
            iVar5 = FUN_0001a010(param_1,iVar6,puVar10,puVar11,iVar18,puVar12,piVar20);
            if (iVar5 != 0) {
              FUN_000230d0(param_1,0,iVar6,0,0,0,*(undefined4 *)(param_1 + 0x15c),
                           *(undefined4 *)(param_1 + 0x160));
            }
            if (*(int *)(param_1 + 0x1d38) != 0) {
              puVar9 = (undefined4 *)(**(code **)(param_1 + 0x2998))(iVar14,2);
              puVar9[1] = 0;
              *puVar9 = ((unsigned char *)0x00001386);
              *(undefined4 **)(param_1 + 0x298c) = puVar9 + 2;
            ...
            if (*(int *)(param_1 + 0x1d38) != 0) {
              puVar9 = (undefined4 *)(**(code **)(param_1 + 0x2998))(iVar14,2);
              *puVar9 = ((unsigned char *)0x00001386);
              puVar9[1] = *(undefined4 *)(param_1 + 0x1d38);
              *(undefined4 **)(param_1 + 0x298c) = puVar9 + 2;
              (**(code **)(param_1 + 0x299c))(iVar14,puVar9 + 2);
            }
          ...
          if ((uVar15 & 0x30000) != 0) {
            ...
            if ((uVar15 & 0x2000) != 0) goto LAB_00029878;
            goto LAB_000298a4;
          }
        }
      }
        ...
        if ((param_6 != 0x1901) && (iVar6 = 4, param_6 != 0x1902)) {
          ...
          if ((bVar1) &&
            ...
            iVar14 = *(int *)(*(int *)(iVar17 + 0x148) + 0x30);
            ...
            iVar14 = *(int *)(*(int *)(iVar17 + 0x144) + 0x30);
        ...
        piVar20 = *(int **)(piVar19[1] + iVar6 * 4);
        if (piVar20 != (int *)0x0) {
          iVar6 = iVar6 * 0x18 + *piVar19;
          uVar3 = *(ushort *)(*piVar20 + 0x18);
          iVar17 = *(int *)(iVar6 + 4);
          iVar14 = *(int *)(iVar6 + 8);
          iVar18 = *(int *)(iVar6 + 0xc);
          iVar6 = iVar14 * 0x18 + iVar17 * 0x168 + piVar20[0xc];
          uVar16 = (uint)*(ushort *)(iVar6 + 0xb2);
          uVar15 = (uint)*(ushort *)(iVar6 + 0xb0);
          _glgConvertType(uVar15,uVar16,&uStack_b4,&uStack_b0);
          iVar5 = *(int *)(param_1 + 0x15c);
          iVar6 = FUN_0000a3f0(uVar15,uVar16);
          uStack_b8 = iVar5 * iVar6;
          iVar5 = uStack_b8 * *(int *)(param_1 + 0x160);
          pvVar8 = _valloc((uint)uVar3 * iVar5);
          FUN_00031340(param_1,piVar20,iVar17,iVar14,uVar15,uVar16,pvVar8,uStack_b8);
          param_3 = param_3 * uStack_b8;
          iVar6 = FUN_0000a3f0(uVar15,uVar16);
          uStack_bc = (int)pvVar8 + param_2 * iVar6 + iVar18 * iVar5 + param_3;
          _glgProcessPixels(puVar13,&uStack_bc);
          _vfree(pvVar8);
          return 1;
        }
    ...
    if (!bVar4) {
      uVar7 = ((int (*)())FUN_00028350)(param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8);
      return uVar7;
    }
LAB_00029bd0:
    uVar7 = 0;
...
LAB_00029a74:
        ...
        if (piVar20 != (int *)0x0) {
          ...
          pvVar8 = _valloc((uint)uVar3 * iVar5);
          FUN_00031340(param_1,piVar20,iVar17,iVar14,uVar15,uVar16,pvVar8,uStack_b8);
          iVar6 = param_3 * uStack_b8;
          iVar14 = FUN_0000a3f0(uVar15,uVar16);
          uStack_bc = (int)pvVar8 + param_2 * iVar14 + iVar18 * iVar5 + iVar6;
          _glgProcessPixels(puVar13,&uStack_bc);
          _vfree(pvVar8);
          return 1;
        }
  ...
  uint param_8;
{
  ...
  if (in_stack_0000003c != 0x1901) {
    if (in_stack_00000043 == '\0') {
      ...
      iVar9 = param_4;
      pfVar14 = param_5;
      FUN_000a6140(iVar21,(*(uint *)(param_1 + 0x1cf8) ^ 1) & 1 |
                          (uint)(in_stack_0000003c == 0x1902) << 0xc,pfVar13);
  ...
  *puVar11 = ((unsigned char *)0x000010c0);
  ...
  *puVar11 = ((unsigned char *)0x00001087);
  ...
  if (in_stack_0000003c != 0x1901) {
    ...
    if (param_4 != 0) {
      ...
      do {
        ...
        if (param_3 != 0) {
          iVar9 = 1;
          pfVar14 = (float *)((unsigned char *)0x00001087);
...
int FUN_0002a3d0(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8)
  int param_1;
  int param_2;
  uint param_3;
  uint param_4;
...
void FUN_0002b740(int param_1,int *param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
...
void FUN_0002bbc4(int param_1,undefined4 *param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  *puVar2 = 0x3b000000;
  ...
  if (iVar15 == 2) {
    puVar2[5] = 0;
    puVar2[4] = ((unsigned char *)0x000013c5);
    uVar6 = 0;
    puVar8 = ((unsigned char *)0x000012fa);
    puVar9 = (uint *)((int)&MACH_HEADER.magic + 1);
    iVar15 = 2;
    puVar11 = puVar2 + 6;
    do {
      puVar14 = puVar11;
      *puVar14 = ((unsigned char *)0x000012fa);
      puVar14[2] = ((unsigned char *)0x000013d7);
      puVar14[3] = 0;
    ...
    *puVar11 = ((unsigned char *)0x000012fa);
    puVar14[7] = uVar13;
    puVar12 = puVar14 + 8;
    puVar14[5] = 3;
    puVar14[6] = ((unsigned char *)0x000013c5);
  }
  else {
    if (iVar16 != 0) {
      uVar6 = 0;
      ...
      do {
        *puVar12 = ((unsigned char *)0x000010b2);
        puVar12[2] = ((unsigned char *)0x000013d7);
        puVar12[3] = 0;
...
void FUN_0002c020(int param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,
...
LAB_0002c610:
    ...
    if ((((uVar8 & 0x180) != 0) || (*(char *)(iVar10 + 0x2a43) != '\0')) &&
      ...
      *(undefined4 **)(FUN_00002748 + param_1 + 4) = puVar6;
      if (((iVar12 == 1) && (uVar8 = *(uint *)(iVar9 + 0x154), (uVar8 & 0x800) == 0)) &&
        ...
        *(uint *)(iVar9 + 0x3c) = uVar8;
        ...
        _io_connect_method_scalarI_structureI(*(undefined4 *)(iVar9 + 4),0);
        puVar6 = (undefined4 *)(**(code **)(param_1 + 0x2758))(param_1,0x22d);
        iVar12 = *(int *)(param_1 + 0x2460);
        *(undefined4 **)(FUN_00002748 + param_1 + 4) = puVar6;
      }
      ...
      *(undefined4 **)(FUN_00002748 + param_1 + 4) = puVar6 + 0x39;
      (*pcVar3)(param_1);
    }
  ...
  int param_2;
{
  ...
  pvVar11 = (void *)(param_1 + 0x240);
  _memset(pvVar11,0,0x2950);
  ...
  *(undefined4 *)(param_1 + 0x1f0) = 0;
  pvVar5 = _malloc(0x44);
  *(void **)(((unsigned char *)0x000027cc) + param_1) = pvVar5;
  _memset(pvVar5,0,0x44);
  pvVar5 = _malloc(0x44);
  *(void **)(FUN_000027d0 + param_1) = pvVar5;
  _memset(pvVar5,0,0x44);
  ...
  *(int *)(param_1 + 0x1dc) = iVar9 + 0x20;
  *(int *)(param_1 + 0x1d8) = iVar9 + 0x1c;
  *(int *)(param_1 + 0x1e0) = iVar9 + 0x20 + *(int *)(iVar9 + 0x10) * 4 + -0x94;
  *(undefined4 *)(iVar9 + 0x1c) = 0;
  *(undefined4 *)(param_1 + 0x1ec) = 0;
  *(undefined4 *)(param_1 + 0x1f0) = 0;
  FUN_000a7050(param_1);
  FUN_000a0f90(pvVar11);
  fparam_1 = (double)FUN_00052cc0(pvVar11);
  ...
  *(undefined4 *)(((unsigned char *)0x00002b78) + param_1) = 0;
  ...
  pvVar5 = pvVar11;
  do {
    *(undefined1 *)((int)pvVar5 + 0x2784) = 0;
  ...
  *(int **)PTR_DAT_001e88cc = piVar1;
  ...
  while( true ) {
    piVar4[0x40] = uVar3;
    uVar3 = 0xffffffff;
    if ((4 < iVar9) && (uVar3 = 0, iVar9 < 8)) {
      uVar3 = 0xffffffff >> (uVar10 + 0x40 & 0x3f);
    }
    piVar4[0x41] = uVar3;
    uVar3 = 0xffffffff;
    if ((8 < iVar9) && (uVar3 = 0, iVar9 < 0xc)) {
      uVar3 = 0xffffffff >> (uVar10 + 0x20 & 0x3f);
    }
    piVar4[0x42] = uVar3;
    uVar3 = 0xffffffff;
    if (0xc < iVar9) {
      uVar3 = 0xffffffff >> (uVar10 & 0x3f);
    }
    piVar4[0x43] = uVar3;
    iVar9 = iVar9 + 1;
    piVar4 = piVar4 + 4;
    ...
    if (iVar12 == 0) break;
    uVar3 = 0xffffffff;
    if ((0 < iVar9) && (uVar3 = 0, iVar9 < 4)) {
      uVar3 = 0xffffffff >> (iVar9 * 8 & 0x38U);
    }
  }
  ...
  ((void (*)())FUN_000a9ac0)(pvVar11,&local_54,uVar7,piVar1,uVar8,DAT_001aa4f8,DAT_001aa4e8,DAT_001aa4f4,fparam_1,
...
uint FUN_0002cc30(int param_1,undefined4 param_2,uint param_3,uint param_4,undefined4 param_5,
                 undefined4 param_6,double fparam_1,double fparam_2,double fparam_3,double fparam_4,
                 double fparam_5,double fparam_6,double fparam_7,double fparam_8,double fparam_9)
  ...
  int param_2;
{
  ...
  *(undefined4 *)(FUN_00002748 + param_1 + 4) = uVar4;
  if (uVar8 != 0) {
    ...
    do {
      if ((uVar8 & 1) != 0) {
        uVar4 = ((int (*)())FUN_0002cd50)(iVar6,*(undefined4 *)(iVar7 + 0x18c),iVar5,uVar4);
      }
      uVar8 = uVar8 >> 1;
      iVar5 = iVar5 + 1;
      iVar7 = iVar7 + 4;
