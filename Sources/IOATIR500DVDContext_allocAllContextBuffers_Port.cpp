/*
 * IOATIR500DVDContext_allocAllContextBuffers_Port.cpp
 *
 * IOATIR500DVDContext::allocAllContextBuffers (real addr 0xeab0, 0 bytes) - mechanically ported from the Ghidra decompile of the shipped kext (Tools/replace_fn.py /
...
/* real addr 0xeab0 */
bool IOATIR500DVDContext::allocAllContextBuffers(UInt32 param_1) {
  ...
  if (piVar2 != (SInt32 *)0x0) {
    ...
    do {
      ...
      pVVar3 = (VendorContextBufferHeader *)VCALL(*piVar2, 0x1cc)(piVar2);
      M<VendorContextBufferHeader *>(pIVar7 + 0xd8) = pVVar3;
      pIVar7 = pIVar7 + 0x18;
      this->init_context_buffer_header((VendorContextBufferHeader *)(pVVar3),param_1);
      bVar1 = iVar6 != 1;
      iVar6 = iVar6 + 1;
