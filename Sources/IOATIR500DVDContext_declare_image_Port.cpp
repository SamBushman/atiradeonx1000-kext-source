/*
 * IOATIR500DVDContext_declare_image_Port.cpp
 *
 * IOATIR500DVDContext::declare_image (real addr 0x103e0, 0 bytes) - mechanically ported from the Ghidra decompile of the shipped kext (Tools/replace_fn.py /
...
/* real addr 0x103e0 */
IOReturn IOATIR500DVDContext::declare_image(UInt32 param_1, unsigned int param_2, UInt32 param_3, unsigned int*param_4) {
