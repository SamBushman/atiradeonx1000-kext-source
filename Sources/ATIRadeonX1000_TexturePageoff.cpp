...
extern "C" void FUN_000210d8(void *dest, void *src, UInt32 size); /* real, unnamed local helper - own body not decompiled this pass, real (dest,src,size) shape strongly suggests memcpy/memmove */
extern "C" void FUN_0001eb18(void *dest, SInt32 byteOffset, UInt32 byteCount); /* real, unnamed local helper - own body not decompiled this pass; real call shape (a CPU-side pointer, a running byte offset, a shifted byte count) is consistent with a real CPU-driven texture-data copy loop, not independently confirmed */
